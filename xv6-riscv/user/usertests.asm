...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	09250513          	addi	a0,a0,146 # 60d0 <malloc+0x44a>
      46:	00006097          	auipc	ra,0x6
      4a:	b82080e7          	jalr	-1150(ra) # 5bc8 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	07050513          	addi	a0,a0,112 # 60f0 <malloc+0x46a>
      88:	00006097          	auipc	ra,0x6
      8c:	b40080e7          	jalr	-1216(ra) # 5bc8 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	06050513          	addi	a0,a0,96 # 6108 <malloc+0x482>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	06250513          	addi	a0,a0,98 # 6128 <malloc+0x4a2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	02a50513          	addi	a0,a0,42 # 6110 <malloc+0x48a>
      ee:	00006097          	auipc	ra,0x6
      f2:	ada080e7          	jalr	-1318(ra) # 5bc8 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	03650513          	addi	a0,a0,54 # 6138 <malloc+0x4b2>
     10a:	00006097          	auipc	ra,0x6
     10e:	abe080e7          	jalr	-1346(ra) # 5bc8 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	03450513          	addi	a0,a0,52 # 6160 <malloc+0x4da>
     134:	00005097          	auipc	ra,0x5
     138:	764080e7          	jalr	1892(ra) # 5898 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	02050513          	addi	a0,a0,32 # 6160 <malloc+0x4da>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	01c58593          	addi	a1,a1,28 # 6170 <malloc+0x4ea>
     15c:	00005097          	auipc	ra,0x5
     160:	70c080e7          	jalr	1804(ra) # 5868 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ff850513          	addi	a0,a0,-8 # 6160 <malloc+0x4da>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	ffc58593          	addi	a1,a1,-4 # 6178 <malloc+0x4f2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fcc50513          	addi	a0,a0,-52 # 6160 <malloc+0x4da>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fb650513          	addi	a0,a0,-74 # 6180 <malloc+0x4fa>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	9f6080e7          	jalr	-1546(ra) # 5bc8 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cd450513          	addi	a0,a0,-812 # 5f50 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cc0a8a93          	addi	s5,s5,-832 # 5f50 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9650513          	addi	a0,a0,-362 # 61a8 <malloc+0x522>
     31a:	00006097          	auipc	ra,0x6
     31e:	8ae080e7          	jalr	-1874(ra) # 5bc8 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	e9250513          	addi	a0,a0,-366 # 61c8 <malloc+0x542>
     33e:	00006097          	auipc	ra,0x6
     342:	88a080e7          	jalr	-1910(ra) # 5bc8 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e6ea0a13          	addi	s4,s4,-402 # 61e0 <malloc+0x55a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	dca50513          	addi	a0,a0,-566 # 61e8 <malloc+0x562>
     426:	00005097          	auipc	ra,0x5
     42a:	7a2080e7          	jalr	1954(ra) # 5bc8 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dc450513          	addi	a0,a0,-572 # 6200 <malloc+0x57a>
     444:	00005097          	auipc	ra,0x5
     448:	784080e7          	jalr	1924(ra) # 5bc8 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	dd650513          	addi	a0,a0,-554 # 6230 <malloc+0x5aa>
     462:	00005097          	auipc	ra,0x5
     466:	766080e7          	jalr	1894(ra) # 5bc8 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	dec50513          	addi	a0,a0,-532 # 6260 <malloc+0x5da>
     47c:	00005097          	auipc	ra,0x5
     480:	74c080e7          	jalr	1868(ra) # 5bc8 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	dde50513          	addi	a0,a0,-546 # 6270 <malloc+0x5ea>
     49a:	00005097          	auipc	ra,0x5
     49e:	72e080e7          	jalr	1838(ra) # 5bc8 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	dd0a0a13          	addi	s4,s4,-560 # 62a0 <malloc+0x61a>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ca0a8a93          	addi	s5,s5,-864 # 6178 <malloc+0x4f2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d2a50513          	addi	a0,a0,-726 # 62a8 <malloc+0x622>
     586:	00005097          	auipc	ra,0x5
     58a:	642080e7          	jalr	1602(ra) # 5bc8 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d2450513          	addi	a0,a0,-732 # 62c0 <malloc+0x63a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	624080e7          	jalr	1572(ra) # 5bc8 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	caa50513          	addi	a0,a0,-854 # 6260 <malloc+0x5da>
     5be:	00005097          	auipc	ra,0x5
     5c2:	60a080e7          	jalr	1546(ra) # 5bc8 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d2050513          	addi	a0,a0,-736 # 62f0 <malloc+0x66a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	5f0080e7          	jalr	1520(ra) # 5bc8 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d1a50513          	addi	a0,a0,-742 # 6308 <malloc+0x682>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5d2080e7          	jalr	1490(ra) # 5bc8 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b2c58593          	addi	a1,a1,-1236 # 6170 <malloc+0x4ea>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b0050513          	addi	a0,a0,-1280 # 6160 <malloc+0x4da>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	ad450513          	addi	a0,a0,-1324 # 6160 <malloc+0x4da>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ac050513          	addi	a0,a0,-1344 # 6160 <malloc+0x4da>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cba58593          	addi	a1,a1,-838 # 6398 <malloc+0x712>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a4050513          	addi	a0,a0,-1472 # 6160 <malloc+0x4da>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bd450513          	addi	a0,a0,-1068 # 6338 <malloc+0x6b2>
     76c:	00005097          	auipc	ra,0x5
     770:	45c080e7          	jalr	1116(ra) # 5bc8 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	bd850513          	addi	a0,a0,-1064 # 6358 <malloc+0x6d2>
     788:	00005097          	auipc	ra,0x5
     78c:	440080e7          	jalr	1088(ra) # 5bc8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bd450513          	addi	a0,a0,-1068 # 6368 <malloc+0x6e2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	42c080e7          	jalr	1068(ra) # 5bc8 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	bd850513          	addi	a0,a0,-1064 # 6388 <malloc+0x702>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	410080e7          	jalr	1040(ra) # 5bc8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	ba450513          	addi	a0,a0,-1116 # 6368 <malloc+0x6e2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	3fc080e7          	jalr	1020(ra) # 5bc8 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bbe50513          	addi	a0,a0,-1090 # 63a0 <malloc+0x71a>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	3de080e7          	jalr	990(ra) # 5bc8 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	bc050513          	addi	a0,a0,-1088 # 63c0 <malloc+0x73a>
     808:	00005097          	auipc	ra,0x5
     80c:	3c0080e7          	jalr	960(ra) # 5bc8 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bac50513          	addi	a0,a0,-1108 # 63e0 <malloc+0x75a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bbc98993          	addi	s3,s3,-1092 # 6408 <malloc+0x782>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	beca8a93          	addi	s5,s5,-1044 # 6440 <malloc+0x7ba>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b4650513          	addi	a0,a0,-1210 # 63e0 <malloc+0x75a>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b0a50513          	addi	a0,a0,-1270 # 63e0 <malloc+0x75a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	ae850513          	addi	a0,a0,-1304 # 63e8 <malloc+0x762>
     908:	00005097          	auipc	ra,0x5
     90c:	2c0080e7          	jalr	704(ra) # 5bc8 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	afa50513          	addi	a0,a0,-1286 # 6418 <malloc+0x792>
     926:	00005097          	auipc	ra,0x5
     92a:	2a2080e7          	jalr	674(ra) # 5bc8 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b1450513          	addi	a0,a0,-1260 # 6450 <malloc+0x7ca>
     944:	00005097          	auipc	ra,0x5
     948:	284080e7          	jalr	644(ra) # 5bc8 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b2050513          	addi	a0,a0,-1248 # 6478 <malloc+0x7f2>
     960:	00005097          	auipc	ra,0x5
     964:	268080e7          	jalr	616(ra) # 5bc8 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b2450513          	addi	a0,a0,-1244 # 6498 <malloc+0x812>
     97c:	00005097          	auipc	ra,0x5
     980:	24c080e7          	jalr	588(ra) # 5bc8 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b2050513          	addi	a0,a0,-1248 # 64b0 <malloc+0x82a>
     998:	00005097          	auipc	ra,0x5
     99c:	230080e7          	jalr	560(ra) # 5bc8 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b0e50513          	addi	a0,a0,-1266 # 64d0 <malloc+0x84a>
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	abc50513          	addi	a0,a0,-1348 # 64d0 <malloc+0x84a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a7c50513          	addi	a0,a0,-1412 # 64d8 <malloc+0x852>
     a64:	00005097          	auipc	ra,0x5
     a68:	164080e7          	jalr	356(ra) # 5bc8 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	a7e50513          	addi	a0,a0,-1410 # 64f8 <malloc+0x872>
     a82:	00005097          	auipc	ra,0x5
     a86:	146080e7          	jalr	326(ra) # 5bc8 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	a8a50513          	addi	a0,a0,-1398 # 6520 <malloc+0x89a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	12a080e7          	jalr	298(ra) # 5bc8 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a0e50513          	addi	a0,a0,-1522 # 64d0 <malloc+0x84a>
     ...
     af2:	a5250513          	addi	a0,a0,-1454 # 6540 <malloc+0x8ba>
     af6:	00005097          	auipc	ra,0x5
     afa:	0d2080e7          	jalr	210(ra) # 5bc8 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a5c50513          	addi	a0,a0,-1444 # 6568 <malloc+0x8e2>
     b14:	00005097          	auipc	ra,0x5
     b18:	0b4080e7          	jalr	180(ra) # 5bc8 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a5650513          	addi	a0,a0,-1450 # 6580 <malloc+0x8fa>
     b32:	00005097          	auipc	ra,0x5
     b36:	096080e7          	jalr	150(ra) # 5bc8 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a6250513          	addi	a0,a0,-1438 # 65a8 <malloc+0x922>
     b4e:	00005097          	auipc	ra,0x5
     b52:	07a080e7          	jalr	122(ra) # 5bc8 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	36c50513          	addi	a0,a0,876 # 5ee0 <malloc+0x25a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a5458593          	addi	a1,a1,-1452 # 65e0 <malloc+0x95a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	33850513          	addi	a0,a0,824 # 5ee0 <malloc+0x25a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	32250513          	addi	a0,a0,802 # 5ee0 <malloc+0x25a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	30c50513          	addi	a0,a0,780 # 5ee0 <malloc+0x25a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a4058593          	addi	a1,a1,-1472 # 6628 <malloc+0x9a2>
  ...
  unlink("unlinkread");
     ...
     c54:	29050513          	addi	a0,a0,656 # 5ee0 <malloc+0x25a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	95050513          	addi	a0,a0,-1712 # 65c0 <malloc+0x93a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f50080e7          	jalr	-176(ra) # 5bc8 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	95c50513          	addi	a0,a0,-1700 # 65e8 <malloc+0x962>
     c94:	00005097          	auipc	ra,0x5
     c98:	f34080e7          	jalr	-204(ra) # 5bc8 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	96050513          	addi	a0,a0,-1696 # 6608 <malloc+0x982>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f18080e7          	jalr	-232(ra) # 5bc8 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	96c50513          	addi	a0,a0,-1684 # 6630 <malloc+0x9aa>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	efc080e7          	jalr	-260(ra) # 5bc8 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	97050513          	addi	a0,a0,-1680 # 6650 <malloc+0x9ca>
     ce8:	00005097          	auipc	ra,0x5
     cec:	ee0080e7          	jalr	-288(ra) # 5bc8 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	97450513          	addi	a0,a0,-1676 # 6670 <malloc+0x9ea>
     d04:	00005097          	auipc	ra,0x5
     d08:	ec4080e7          	jalr	-316(ra) # 5bc8 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	88058593          	addi	a1,a1,-1920 # 65e0 <malloc+0x95a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	91858593          	addi	a1,a1,-1768 # 6698 <malloc+0xa12>
     d88:	00006517          	auipc	a0,0x6
     d8c:	90850513          	addi	a0,a0,-1784 # 6690 <malloc+0xa0a>
  ...
  unlink("lf1");
     ...
     da0:	8f450513          	addi	a0,a0,-1804 # 6690 <malloc+0xa0a>
     da4:	00005097          	auipc	ra,0x5
     da8:	af4080e7          	jalr	-1292(ra) # 5898 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	8e250513          	addi	a0,a0,-1822 # 6690 <malloc+0xa0a>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	8d450513          	addi	a0,a0,-1836 # 6698 <malloc+0xa12>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	89c58593          	addi	a1,a1,-1892 # 6698 <malloc+0xa12>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	88650513          	addi	a0,a0,-1914 # 6698 <malloc+0xa12>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a7e080e7          	jalr	-1410(ra) # 5898 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	86e58593          	addi	a1,a1,-1938 # 6690 <malloc+0xa0a>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	86e50513          	addi	a0,a0,-1938 # 6698 <malloc+0xa12>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	85258593          	addi	a1,a1,-1966 # 6690 <malloc+0xa0a>
     e46:	00006517          	auipc	a0,0x6
     e4a:	95a50513          	addi	a0,a0,-1702 # 67a0 <malloc+0xb1a>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	83850513          	addi	a0,a0,-1992 # 66a0 <malloc+0xa1a>
     e70:	00005097          	auipc	ra,0x5
     e74:	d58080e7          	jalr	-680(ra) # 5bc8 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	83450513          	addi	a0,a0,-1996 # 66b8 <malloc+0xa32>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d3c080e7          	jalr	-708(ra) # 5bc8 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	83050513          	addi	a0,a0,-2000 # 66d0 <malloc+0xa4a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d20080e7          	jalr	-736(ra) # 5bc8 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	83450513          	addi	a0,a0,-1996 # 66f0 <malloc+0xa6a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d04080e7          	jalr	-764(ra) # 5bc8 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	84850513          	addi	a0,a0,-1976 # 6720 <malloc+0xa9a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	ce8080e7          	jalr	-792(ra) # 5bc8 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	84450513          	addi	a0,a0,-1980 # 6738 <malloc+0xab2>
     efc:	00005097          	auipc	ra,0x5
     f00:	ccc080e7          	jalr	-820(ra) # 5bc8 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	84050513          	addi	a0,a0,-1984 # 6750 <malloc+0xaca>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cb0080e7          	jalr	-848(ra) # 5bc8 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	84c50513          	addi	a0,a0,-1972 # 6778 <malloc+0xaf2>
     f34:	00005097          	auipc	ra,0x5
     f38:	c94080e7          	jalr	-876(ra) # 5bc8 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	86050513          	addi	a0,a0,-1952 # 67a8 <malloc+0xb22>
     f50:	00005097          	auipc	ra,0x5
     f54:	c78080e7          	jalr	-904(ra) # 5bc8 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	81aa0a13          	addi	s4,s4,-2022 # 67c8 <malloc+0xb42>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	7c850513          	addi	a0,a0,1992 # 67c8 <malloc+0xb42>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	76050513          	addi	a0,a0,1888 # 67d0 <malloc+0xb4a>
    1078:	00005097          	auipc	ra,0x5
    107c:	b50080e7          	jalr	-1200(ra) # 5bc8 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	76050513          	addi	a0,a0,1888 # 67f0 <malloc+0xb6a>
    1098:	00005097          	auipc	ra,0x5
    109c:	b30080e7          	jalr	-1232(ra) # 5bc8 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	76450513          	addi	a0,a0,1892 # 6810 <malloc+0xb8a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b14080e7          	jalr	-1260(ra) # 5bc8 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	75298993          	addi	s3,s3,1874 # 6830 <malloc+0xbaa>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	72650513          	addi	a0,a0,1830 # 6840 <malloc+0xbba>
    1122:	00005097          	auipc	ra,0x5
    1126:	aa6080e7          	jalr	-1370(ra) # 5bc8 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	f8298993          	addi	s3,s3,-126 # 6108 <malloc+0x482>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	81878793          	addi	a5,a5,-2024 # 7a28 <malloc+0x1da2>
  ...
  if(pid == 0){
    ...
    124a:	43278793          	addi	a5,a5,1074 # 8678 <big.0>
    ...
    1270:	ecc78793          	addi	a5,a5,-308 # 8138 <malloc+0x24b2>
    ...
    1294:	e7850513          	addi	a0,a0,-392 # 6108 <malloc+0x482>
    ...
    12ac:	64050513          	addi	a0,a0,1600 # 68e8 <malloc+0xc62>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	918080e7          	jalr	-1768(ra) # 5bc8 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	59850513          	addi	a0,a0,1432 # 6860 <malloc+0xbda>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	8f8080e7          	jalr	-1800(ra) # 5bc8 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	59850513          	addi	a0,a0,1432 # 6880 <malloc+0xbfa>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	8d8080e7          	jalr	-1832(ra) # 5bc8 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	59650513          	addi	a0,a0,1430 # 68a0 <malloc+0xc1a>
    1312:	00005097          	auipc	ra,0x5
    1316:	8b6080e7          	jalr	-1866(ra) # 5bc8 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	59e50513          	addi	a0,a0,1438 # 68c8 <malloc+0xc42>
    1332:	00005097          	auipc	ra,0x5
    1336:	896080e7          	jalr	-1898(ra) # 5bc8 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a1c50513          	addi	a0,a0,-1508 # 6d60 <malloc+0x10da>
    134c:	00005097          	auipc	ra,0x5
    1350:	87c080e7          	jalr	-1924(ra) # 5bc8 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	58250513          	addi	a0,a0,1410 # 6910 <malloc+0xc8a>
    1396:	00005097          	auipc	ra,0x5
    139a:	832080e7          	jalr	-1998(ra) # 5bc8 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	da050513          	addi	a0,a0,-608 # 6160 <malloc+0x4da>
  ...
  if(pid == 0){
    ...
    13ee:	d76a0a13          	addi	s4,s4,-650 # 6160 <malloc+0x4da>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	57ea8a93          	addi	s5,s5,1406 # 6970 <malloc+0xcea>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	4de50513          	addi	a0,a0,1246 # 6940 <malloc+0xcba>
    146a:	00004097          	auipc	ra,0x4
    146e:	75e080e7          	jalr	1886(ra) # 5bc8 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	4da50513          	addi	a0,a0,1242 # 6958 <malloc+0xcd2>
    1486:	00004097          	auipc	ra,0x4
    148a:	742080e7          	jalr	1858(ra) # 5bc8 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	4e450513          	addi	a0,a0,1252 # 6980 <malloc+0xcfa>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	724080e7          	jalr	1828(ra) # 5bc8 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	ca6a0a13          	addi	s4,s4,-858 # 6160 <malloc+0x4da>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	4dea8a93          	addi	s5,s5,1246 # 69a0 <malloc+0xd1a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c5450513          	addi	a0,a0,-940 # 6160 <malloc+0x4da>
  ...
  exit(xstatus);
    ...
    152e:	42e50513          	addi	a0,a0,1070 # 6958 <malloc+0xcd2>
    1532:	00004097          	auipc	ra,0x4
    1536:	696080e7          	jalr	1686(ra) # 5bc8 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	46050513          	addi	a0,a0,1120 # 69a8 <malloc+0xd22>
    1550:	00004097          	auipc	ra,0x4
    1554:	678080e7          	jalr	1656(ra) # 5bc8 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	b9878793          	addi	a5,a5,-1128 # 6108 <malloc+0x482>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	44c78793          	addi	a5,a5,1100 # 69c8 <malloc+0xd42>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	44450513          	addi	a0,a0,1092 # 69d0 <malloc+0xd4a>
  ...
  if(pid == 0) {
    ...
    15be:	41650513          	addi	a0,a0,1046 # 69d0 <malloc+0xd4a>
    ...
    15da:	41a50513          	addi	a0,a0,1050 # 69f0 <malloc+0xd6a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	5ea080e7          	jalr	1514(ra) # 5bc8 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	34e50513          	addi	a0,a0,846 # 6940 <malloc+0xcba>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	5ce080e7          	jalr	1486(ra) # 5bc8 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	3ca50513          	addi	a0,a0,970 # 69d8 <malloc+0xd52>
    1616:	00004097          	auipc	ra,0x4
    161a:	5b2080e7          	jalr	1458(ra) # 5bc8 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	adc50513          	addi	a0,a0,-1316 # 6108 <malloc+0x482>
  ...
  if(xstatus != 0)
    ...
    1664:	3a050513          	addi	a0,a0,928 # 6a00 <malloc+0xd7a>
    1668:	00004097          	auipc	ra,0x4
    166c:	560080e7          	jalr	1376(ra) # 5bc8 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	39c50513          	addi	a0,a0,924 # 6a18 <malloc+0xd92>
    1684:	00004097          	auipc	ra,0x4
    1688:	544080e7          	jalr	1348(ra) # 5bc8 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	34050513          	addi	a0,a0,832 # 69d0 <malloc+0xd4a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	dde50513          	addi	a0,a0,-546 # 6498 <malloc+0x812>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	506080e7          	jalr	1286(ra) # 5bc8 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	28250513          	addi	a0,a0,642 # 6958 <malloc+0xcd2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	4ea080e7          	jalr	1258(ra) # 5bc8 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	2e050513          	addi	a0,a0,736 # 69d0 <malloc+0xd4a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	31650513          	addi	a0,a0,790 # 6a30 <malloc+0xdaa>
    1722:	00004097          	auipc	ra,0x4
    1726:	4a6080e7          	jalr	1190(ra) # 5bc8 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	26c50513          	addi	a0,a0,620 # 6a48 <malloc+0xdc2>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	3e4080e7          	jalr	996(ra) # 5bc8 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	1fe50513          	addi	a0,a0,510 # 6a60 <malloc+0xdda>
    186a:	00004097          	auipc	ra,0x4
    186e:	35e080e7          	jalr	862(ra) # 5bc8 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	1fa50513          	addi	a0,a0,506 # 6a78 <malloc+0xdf2>
    1886:	00004097          	auipc	ra,0x4
    188a:	342080e7          	jalr	834(ra) # 5bc8 <printf>
}
    ...
    18b4:	1e050513          	addi	a0,a0,480 # 6a90 <malloc+0xe0a>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	310080e7          	jalr	784(ra) # 5bc8 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1c050513          	addi	a0,a0,448 # 6ab0 <malloc+0xe2a>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	2d0080e7          	jalr	720(ra) # 5bc8 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	fde50513          	addi	a0,a0,-34 # 6940 <malloc+0xcba>
    196a:	00004097          	auipc	ra,0x4
    196e:	25e080e7          	jalr	606(ra) # 5bc8 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	14a50513          	addi	a0,a0,330 # 6ac8 <malloc+0xe42>
    1986:	00004097          	auipc	ra,0x4
    198a:	242080e7          	jalr	578(ra) # 5bc8 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	14650513          	addi	a0,a0,326 # 6ae0 <malloc+0xe5a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	226080e7          	jalr	550(ra) # 5bc8 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f2e50513          	addi	a0,a0,-210 # 6940 <malloc+0xcba>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1ae080e7          	jalr	430(ra) # 5bc8 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f0a50513          	addi	a0,a0,-246 # 6940 <malloc+0xcba>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	18a080e7          	jalr	394(ra) # 5bc8 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	05050513          	addi	a0,a0,80 # 6b00 <malloc+0xe7a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	110080e7          	jalr	272(ra) # 5bc8 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d86080e7          	jalr	-634(ra) # 5848 <exit>
{
    ...
    1b0c:	00850513          	addi	a0,a0,8 # 6b10 <malloc+0xe8a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0b8080e7          	jalr	184(ra) # 5bc8 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	20a50513          	addi	a0,a0,522 # 6d60 <malloc+0x10da>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	06a080e7          	jalr	106(ra) # 5bc8 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	16c50513          	addi	a0,a0,364 # 6d60 <malloc+0x10da>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	fcc080e7          	jalr	-52(ra) # 5bc8 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	db850513          	addi	a0,a0,-584 # 69d8 <malloc+0xd52>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fa0080e7          	jalr	-96(ra) # 5bc8 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	e9e50513          	addi	a0,a0,-354 # 6b30 <malloc+0xeaa>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f2e080e7          	jalr	-210(ra) # 5bc8 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	e8250513          	addi	a0,a0,-382 # 6b48 <malloc+0xec2>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	efa080e7          	jalr	-262(ra) # 5bc8 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e4450513          	addi	a0,a0,-444 # 6b70 <malloc+0xeea>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	e94080e7          	jalr	-364(ra) # 5bc8 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3ac50513          	addi	a0,a0,940 # 6178 <malloc+0x4f2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	370a8a93          	addi	s5,s5,880 # 6178 <malloc+0x4f2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	d88b8b93          	addi	s7,s7,-632 # 6b98 <malloc+0xf12>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b2450513          	addi	a0,a0,-1244 # 6940 <malloc+0xcba>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	da4080e7          	jalr	-604(ra) # 5bc8 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e5650513          	addi	a0,a0,-426 # 6d60 <malloc+0x10da>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cb6080e7          	jalr	-842(ra) # 5bc8 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e4ab0b13          	addi	s6,s6,-438 # bd90 <buf>
    ...
    1fbe:	be650513          	addi	a0,a0,-1050 # 6ba0 <malloc+0xf1a>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c06080e7          	jalr	-1018(ra) # 5bc8 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	1ee50513          	addi	a0,a0,494 # 61c8 <malloc+0x542>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	be6080e7          	jalr	-1050(ra) # 5bc8 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	ba850513          	addi	a0,a0,-1112 # 6bd0 <malloc+0xf4a>
    2030:	00004097          	auipc	ra,0x4
    2034:	b98080e7          	jalr	-1128(ra) # 5bc8 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b2e50513          	addi	a0,a0,-1234 # 6bb8 <malloc+0xf32>
    2092:	00004097          	auipc	ra,0x4
    2096:	b36080e7          	jalr	-1226(ra) # 5bc8 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b5250513          	addi	a0,a0,-1198 # 6bf8 <malloc+0xf72>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b1a080e7          	jalr	-1254(ra) # 5bc8 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b4e50513          	addi	a0,a0,-1202 # 6c10 <malloc+0xf8a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	afe080e7          	jalr	-1282(ra) # 5bc8 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	7fe50513          	addi	a0,a0,2046 # 6940 <malloc+0xcba>
    214a:	00004097          	auipc	ra,0x4
    214e:	a7e080e7          	jalr	-1410(ra) # 5bc8 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	ac450513          	addi	a0,a0,-1340 # 6c28 <malloc+0xfa2>
    216c:	00004097          	auipc	ra,0x4
    2170:	a5c080e7          	jalr	-1444(ra) # 5bc8 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	75a50513          	addi	a0,a0,1882 # 6940 <malloc+0xcba>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	9da080e7          	jalr	-1574(ra) # 5bc8 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a3650513          	addi	a0,a0,-1482 # 6c48 <malloc+0xfc2>
    221a:	00004097          	auipc	ra,0x4
    221e:	9ae080e7          	jalr	-1618(ra) # 5bc8 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a1e50513          	addi	a0,a0,-1506 # 6c60 <malloc+0xfda>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	9ec50513          	addi	a0,a0,-1556 # 6c60 <malloc+0xfda>
  ...
  close(fd);
    ...
    229e:	2de78793          	addi	a5,a5,734 # 8578 <args.1>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3ce68693          	addi	a3,a3,974 # 8670 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9c670713          	addi	a4,a4,-1594 # 6c70 <malloc+0xfea>
    ...
    2302:	a5250513          	addi	a0,a0,-1454 # 6d50 <malloc+0x10ca>
    2306:	00004097          	auipc	ra,0x4
    230a:	8c2080e7          	jalr	-1854(ra) # 5bc8 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a4e50513          	addi	a0,a0,-1458 # 6d70 <malloc+0x10ea>
    232a:	00004097          	auipc	ra,0x4
    232e:	89e080e7          	jalr	-1890(ra) # 5bc8 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2384:	a1050513          	addi	a0,a0,-1520 # 6d90 <malloc+0x110a>
    2388:	00004097          	auipc	ra,0x4
    238c:	840080e7          	jalr	-1984(ra) # 5bc8 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5a450513          	addi	a0,a0,1444 # 6940 <malloc+0xcba>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	824080e7          	jalr	-2012(ra) # 5bc8 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	5f278793          	addi	a5,a5,1522 # 7a28 <malloc+0x1da2>
  ...
  if(ret != -1){
    ...
    247c:	94050513          	addi	a0,a0,-1728 # 6db8 <malloc+0x1132>
    2480:	00003097          	auipc	ra,0x3
    2484:	748080e7          	jalr	1864(ra) # 5bc8 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	3ca50513          	addi	a0,a0,970 # 6860 <malloc+0xbda>
    249e:	00003097          	auipc	ra,0x3
    24a2:	72a080e7          	jalr	1834(ra) # 5bc8 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	3cc50513          	addi	a0,a0,972 # 6880 <malloc+0xbfa>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	70c080e7          	jalr	1804(ra) # 5bc8 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	3cc50513          	addi	a0,a0,972 # 68a0 <malloc+0xc1a>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	6ec080e7          	jalr	1772(ra) # 5bc8 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	3d650513          	addi	a0,a0,982 # 68c8 <malloc+0xc42>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	6ce080e7          	jalr	1742(ra) # 5bc8 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8ba50513          	addi	a0,a0,-1862 # 5df8 <malloc+0x172>
  ...
  if(n >= 0){
    ...
    2574:	8a050513          	addi	a0,a0,-1888 # 6e10 <malloc+0x118a>
    2578:	00003097          	auipc	ra,0x3
    257c:	650080e7          	jalr	1616(ra) # 5bc8 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	83650513          	addi	a0,a0,-1994 # 6dc0 <malloc+0x113a>
    2592:	00003097          	auipc	ra,0x3
    2596:	636080e7          	jalr	1590(ra) # 5bc8 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	83450513          	addi	a0,a0,-1996 # 6dd8 <malloc+0x1152>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	61c080e7          	jalr	1564(ra) # 5bc8 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	83a50513          	addi	a0,a0,-1990 # 6df8 <malloc+0x1172>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	602080e7          	jalr	1538(ra) # 5bc8 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	81650513          	addi	a0,a0,-2026 # 5df8 <malloc+0x172>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2ae080e7          	jalr	686(ra) # 5898 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	cac50513          	addi	a0,a0,-852 # 62a0 <malloc+0x61a>
  ...
  if(n >= 0){
    ...
    2622:	82250513          	addi	a0,a0,-2014 # 6e40 <malloc+0x11ba>
    2626:	00003097          	auipc	ra,0x3
    262a:	5a2080e7          	jalr	1442(ra) # 5bc8 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7c050513          	addi	a0,a0,1984 # 6df8 <malloc+0x1172>
    2640:	00003097          	auipc	ra,0x3
    2644:	588080e7          	jalr	1416(ra) # 5bc8 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a2:	6705                	lui	a4,0x1
      *b = 99;
    26a4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1260>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26bc:	7b050513          	addi	a0,a0,1968 # 6e68 <malloc+0x11e2>
    26c0:	00003097          	auipc	ra,0x3
    26c4:	508080e7          	jalr	1288(ra) # 5bc8 <printf>
    exit(1);
    26c8:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    270e:	77e50513          	addi	a0,a0,1918 # 6e88 <malloc+0x1202>
    2712:	00003097          	auipc	ra,0x3
    2716:	4b6080e7          	jalr	1206(ra) # 5bc8 <printf>
    exit(1);
    271a:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2772:	77a50513          	addi	a0,a0,1914 # 6ee8 <malloc+0x1262>
    2776:	00003097          	auipc	ra,0x3
    277a:	452080e7          	jalr	1106(ra) # 5bc8 <printf>
    exit(1);
    277e:	4505                	li	a0,1
    ...
    2794:	71850513          	addi	a0,a0,1816 # 6ea8 <malloc+0x1222>
    2798:	00003097          	auipc	ra,0x3
    279c:	430080e7          	jalr	1072(ra) # 5bc8 <printf>
      exit(1);
    27a0:	4505                	li	a0,1
    ...
    27b0:	71c50513          	addi	a0,a0,1820 # 6ec8 <malloc+0x1242>
    27b4:	00003097          	auipc	ra,0x3
    27b8:	414080e7          	jalr	1044(ra) # 5bc8 <printf>
    exit(1);
    27bc:	4505                	li	a0,1
...
00000000000027ec <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    284e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f125f>
  a = sbrk(0);
    2852:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b2:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f125f>
  ...
  if(c != a){
    ...
    28fa:	61250513          	addi	a0,a0,1554 # 6f08 <malloc+0x1282>
    28fe:	00003097          	auipc	ra,0x3
    2902:	2ca080e7          	jalr	714(ra) # 5bc8 <printf>
    exit(1);
    2906:	4505                	li	a0,1
    ...
    2916:	63e50513          	addi	a0,a0,1598 # 6f50 <malloc+0x12ca>
    291a:	00003097          	auipc	ra,0x3
    291e:	2ae080e7          	jalr	686(ra) # 5bc8 <printf>
    exit(1);
    2922:	4505                	li	a0,1
    ...
    2936:	63e50513          	addi	a0,a0,1598 # 6f70 <malloc+0x12ea>
    293a:	00003097          	auipc	ra,0x3
    293e:	28e080e7          	jalr	654(ra) # 5bc8 <printf>
    exit(1);
    2942:	4505                	li	a0,1
    ...
    2956:	65e50513          	addi	a0,a0,1630 # 6fb0 <malloc+0x132a>
    295a:	00003097          	auipc	ra,0x3
    295e:	26e080e7          	jalr	622(ra) # 5bc8 <printf>
    exit(1);
    2962:	4505                	li	a0,1
    ...
    2972:	67250513          	addi	a0,a0,1650 # 6fe0 <malloc+0x135a>
    2976:	00003097          	auipc	ra,0x3
    297a:	252080e7          	jalr	594(ra) # 5bc8 <printf>
    exit(1);
    297e:	4505                	li	a0,1
    ...
    2992:	68a50513          	addi	a0,a0,1674 # 7018 <malloc+0x1392>
    2996:	00003097          	auipc	ra,0x3
    299a:	232080e7          	jalr	562(ra) # 5bc8 <printf>
    exit(1);
    299e:	4505                	li	a0,1
...
00000000000029a8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29cc:	67850513          	addi	a0,a0,1656 # 7040 <malloc+0x13ba>
    29d0:	00003097          	auipc	ra,0x3
    29d4:	eb8080e7          	jalr	-328(ra) # 5888 <open>
    29d8:	84aa                	mv	s1,a0
  unlink("sbrk");
    29da:	00004517          	auipc	a0,0x4
    29de:	66650513          	addi	a0,a0,1638 # 7040 <malloc+0x13ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a32:	61a50513          	addi	a0,a0,1562 # 7048 <malloc+0x13c2>
    2a36:	00003097          	auipc	ra,0x3
    2a3a:	192080e7          	jalr	402(ra) # 5bc8 <printf>
    exit(1);
    2a3e:	4505                	li	a0,1
    ...
    2a4e:	61650513          	addi	a0,a0,1558 # 7060 <malloc+0x13da>
    2a52:	00003097          	auipc	ra,0x3
    2a56:	176080e7          	jalr	374(ra) # 5bc8 <printf>
    exit(1);
    2a5a:	4505                	li	a0,1
    ...
    2a6a:	fe250513          	addi	a0,a0,-30 # 6a48 <malloc+0xdc2>
    2a6e:	00003097          	auipc	ra,0x3
    2a72:	15a080e7          	jalr	346(ra) # 5bc8 <printf>
    exit(1);
    2a76:	4505                	li	a0,1
...
0000000000002a80 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a94:	5e850513          	addi	a0,a0,1512 # 7078 <malloc+0x13f2>
  ...
  close(fd);
    ...
    2adc:	e8050513          	addi	a0,a0,-384 # 6958 <malloc+0xcd2>
    2ae0:	00003097          	auipc	ra,0x3
    2ae4:	0e8080e7          	jalr	232(ra) # 5bc8 <printf>
    exit(1);
    2ae8:	4505                	li	a0,1
...
0000000000002af2 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2a:	23a50513          	addi	a0,a0,570 # 6d60 <malloc+0x10da>
    2b2e:	00003097          	auipc	ra,0x3
    2b32:	09a080e7          	jalr	154(ra) # 5bc8 <printf>
    exit(1);
    2b36:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b80:	1e450513          	addi	a0,a0,484 # 6d60 <malloc+0x10da>
    2b84:	00003097          	auipc	ra,0x3
    2b88:	044080e7          	jalr	68(ra) # 5bc8 <printf>
    exit(1);
    2b8c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be0:	18450513          	addi	a0,a0,388 # 6d60 <malloc+0x10da>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	fe4080e7          	jalr	-28(ra) # 5bc8 <printf>
    exit(1);
    2bec:	4505                	li	a0,1
...
0000000000002cdc <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfc:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff125f>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d54:	01050513          	addi	a0,a0,16 # 6d60 <malloc+0x10da>
    2d58:	00003097          	auipc	ra,0x3
    2d5c:	e70080e7          	jalr	-400(ra) # 5bc8 <printf>
      exit(1);
    2d60:	4505                	li	a0,1
    ...
    2da8:	36450513          	addi	a0,a0,868 # 6108 <malloc+0x482>
    2dac:	faa43c23          	sd	a0,-72(s0)
    2db0:	00003797          	auipc	a5,0x3
    2db4:	3c878793          	addi	a5,a5,968 # 6178 <malloc+0x4f2>
...
0000000000002dd6 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de6:	46e50513          	addi	a0,a0,1134 # 7250 <malloc+0x15ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df8:	2b450513          	addi	a0,a0,692 # 70a8 <malloc+0x1422>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e0e:	2f650513          	addi	a0,a0,758 # 7100 <malloc+0x147a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2c:	35050513          	addi	a0,a0,848 # 7178 <malloc+0x14f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e48:	3a450513          	addi	a0,a0,932 # 71e8 <malloc+0x1562>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5a:	3ea50513          	addi	a0,a0,1002 # 7240 <malloc+0x15ba>
  ...
  unlink("12345678901234");
    ...
    2ed8:	1ac50513          	addi	a0,a0,428 # 7080 <malloc+0x13fa>
    2edc:	00003097          	auipc	ra,0x3
    2ee0:	cec080e7          	jalr	-788(ra) # 5bc8 <printf>
    exit(1);
    2ee4:	4505                	li	a0,1
    ...
    2ef4:	1d850513          	addi	a0,a0,472 # 70c8 <malloc+0x1442>
    2ef8:	00003097          	auipc	ra,0x3
    2efc:	cd0080e7          	jalr	-816(ra) # 5bc8 <printf>
    exit(1);
    2f00:	4505                	li	a0,1
    ...
    2f10:	22450513          	addi	a0,a0,548 # 7130 <malloc+0x14aa>
    2f14:	00003097          	auipc	ra,0x3
    2f18:	cb4080e7          	jalr	-844(ra) # 5bc8 <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f2c:	28050513          	addi	a0,a0,640 # 71a8 <malloc+0x1522>
    2f30:	00003097          	auipc	ra,0x3
    2f34:	c98080e7          	jalr	-872(ra) # 5bc8 <printf>
    exit(1);
    2f38:	4505                	li	a0,1
    ...
    2f48:	2c450513          	addi	a0,a0,708 # 7208 <malloc+0x1582>
    2f4c:	00003097          	auipc	ra,0x3
    2f50:	c7c080e7          	jalr	-900(ra) # 5bc8 <printf>
    exit(1);
    2f54:	4505                	li	a0,1
    ...
    2f64:	30050513          	addi	a0,a0,768 # 7260 <malloc+0x15da>
    2f68:	00003097          	auipc	ra,0x3
    2f6c:	c60080e7          	jalr	-928(ra) # 5bc8 <printf>
    exit(1);
    2f70:	4505                	li	a0,1
...
0000000000002f7a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8a:	31250513          	addi	a0,a0,786 # 7298 <malloc+0x1612>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f9e:	2fe50513          	addi	a0,a0,766 # 7298 <malloc+0x1612>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb2:	32a50513          	addi	a0,a0,810 # 72d8 <malloc+0x1652>
  ...
  if(chdir("/") < 0){
    ...
    2fc6:	34650513          	addi	a0,a0,838 # 7308 <malloc+0x1682>
    ...
    2fe6:	2be50513          	addi	a0,a0,702 # 72a0 <malloc+0x161a>
    2fea:	00003097          	auipc	ra,0x3
    2fee:	bde080e7          	jalr	-1058(ra) # 5bc8 <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    3002:	2ba50513          	addi	a0,a0,698 # 72b8 <malloc+0x1632>
    3006:	00003097          	auipc	ra,0x3
    300a:	bc2080e7          	jalr	-1086(ra) # 5bc8 <printf>
    exit(1);
    300e:	4505                	li	a0,1
    ...
    301e:	2ce50513          	addi	a0,a0,718 # 72e8 <malloc+0x1662>
    3022:	00003097          	auipc	ra,0x3
    3026:	ba6080e7          	jalr	-1114(ra) # 5bc8 <printf>
    exit(1);
    302a:	4505                	li	a0,1
    ...
    303a:	2da50513          	addi	a0,a0,730 # 7310 <malloc+0x168a>
    303e:	00003097          	auipc	ra,0x3
    3042:	b8a080e7          	jalr	-1142(ra) # 5bc8 <printf>
    exit(1);
    3046:	4505                	li	a0,1
...
0000000000003050 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    306e:	22e50513          	addi	a0,a0,558 # 7298 <malloc+0x1612>
    ...
    3082:	21a50513          	addi	a0,a0,538 # 7298 <malloc+0x1612>
    ...
    3096:	24650513          	addi	a0,a0,582 # 72d8 <malloc+0x1652>
    ...
    30b6:	88e50513          	addi	a0,a0,-1906 # 6940 <malloc+0xcba>
    30ba:	00003097          	auipc	ra,0x3
    30be:	b0e080e7          	jalr	-1266(ra) # 5bc8 <printf>
    exit(1);
    30c2:	4505                	li	a0,1
    ...
    30d2:	1d250513          	addi	a0,a0,466 # 72a0 <malloc+0x161a>
    30d6:	00003097          	auipc	ra,0x3
    30da:	af2080e7          	jalr	-1294(ra) # 5bc8 <printf>
      exit(1);
    30de:	4505                	li	a0,1
    ...
    30ee:	23e50513          	addi	a0,a0,574 # 7328 <malloc+0x16a2>
    30f2:	00003097          	auipc	ra,0x3
    30f6:	ad6080e7          	jalr	-1322(ra) # 5bc8 <printf>
      exit(1);
    30fa:	4505                	li	a0,1
    ...
    310a:	1e250513          	addi	a0,a0,482 # 72e8 <malloc+0x1662>
    310e:	00003097          	auipc	ra,0x3
    3112:	aba080e7          	jalr	-1350(ra) # 5bc8 <printf>
      exit(1);
    3116:	4505                	li	a0,1
...
0000000000003138 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3148:	1fc50513          	addi	a0,a0,508 # 7340 <malloc+0x16ba>
  ...
  if(chdir("dir0") < 0){
    ...
    315c:	1e850513          	addi	a0,a0,488 # 7340 <malloc+0x16ba>
  ...
  if(chdir("..") < 0){
    ...
    3170:	1f450513          	addi	a0,a0,500 # 7360 <malloc+0x16da>
  ...
  if(unlink("dir0") < 0){
    ...
    3184:	1c050513          	addi	a0,a0,448 # 7340 <malloc+0x16ba>
    ...
    31a4:	10050513          	addi	a0,a0,256 # 72a0 <malloc+0x161a>
    31a8:	00003097          	auipc	ra,0x3
    31ac:	a20080e7          	jalr	-1504(ra) # 5bc8 <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31c0:	18c50513          	addi	a0,a0,396 # 7348 <malloc+0x16c2>
    31c4:	00003097          	auipc	ra,0x3
    31c8:	a04080e7          	jalr	-1532(ra) # 5bc8 <printf>
    exit(1);
    31cc:	4505                	li	a0,1
    ...
    31dc:	19050513          	addi	a0,a0,400 # 7368 <malloc+0x16e2>
    31e0:	00003097          	auipc	ra,0x3
    31e4:	9e8080e7          	jalr	-1560(ra) # 5bc8 <printf>
    exit(1);
    31e8:	4505                	li	a0,1
    ...
    31f8:	18c50513          	addi	a0,a0,396 # 7380 <malloc+0x16fa>
    31fc:	00003097          	auipc	ra,0x3
    3200:	9cc080e7          	jalr	-1588(ra) # 5bc8 <printf>
    exit(1);
    3204:	4505                	li	a0,1
...
000000000000320e <subdir>:
{
  ...
  unlink("ff");
    ...
    3220:	2ac50513          	addi	a0,a0,684 # 74c8 <malloc+0x1842>
    3224:	00002097          	auipc	ra,0x2
    3228:	674080e7          	jalr	1652(ra) # 5898 <unlink>
  if(mkdir("dd") != 0){
    322c:	00004517          	auipc	a0,0x4
    3230:	16c50513          	addi	a0,a0,364 # 7398 <malloc+0x1712>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3248:	17450513          	addi	a0,a0,372 # 73b8 <malloc+0x1732>
  ...
  write(fd, "ff", 2);
    ...
    3260:	26c58593          	addi	a1,a1,620 # 74c8 <malloc+0x1842>
  ...
  if(unlink("dd") >= 0){
    ...
    327a:	12250513          	addi	a0,a0,290 # 7398 <malloc+0x1712>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    328e:	18650513          	addi	a0,a0,390 # 7410 <malloc+0x178a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a6:	19650513          	addi	a0,a0,406 # 7438 <malloc+0x17b2>
  ...
  write(fd, "FF", 2);
    ...
    32be:	1ae58593          	addi	a1,a1,430 # 7468 <malloc+0x17e2>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32da:	19a50513          	addi	a0,a0,410 # 7470 <malloc+0x17ea>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f2:	aa258593          	addi	a1,a1,-1374 # bd90 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3308:	a8c74703          	lbu	a4,-1396(a4) # bd90 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3322:	1a258593          	addi	a1,a1,418 # 74c0 <malloc+0x183a>
    3326:	00004517          	auipc	a0,0x4
    332a:	11250513          	addi	a0,a0,274 # 7438 <malloc+0x17b2>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    333e:	0fe50513          	addi	a0,a0,254 # 7438 <malloc+0x17b2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3354:	0e850513          	addi	a0,a0,232 # 7438 <malloc+0x17b2>
  ...
  if(chdir("dd") != 0){
    ...
    3368:	03450513          	addi	a0,a0,52 # 7398 <malloc+0x1712>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337c:	1e050513          	addi	a0,a0,480 # 7558 <malloc+0x18d2>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3390:	1fc50513          	addi	a0,a0,508 # 7588 <malloc+0x1902>
  ...
  if(chdir("./..") != 0){
    ...
    33a4:	21850513          	addi	a0,a0,536 # 75b8 <malloc+0x1932>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33ba:	10a50513          	addi	a0,a0,266 # 74c0 <malloc+0x183a>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d2:	9c258593          	addi	a1,a1,-1598 # bd90 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f4:	04850513          	addi	a0,a0,72 # 7438 <malloc+0x17b2>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340c:	24050513          	addi	a0,a0,576 # 7648 <malloc+0x19c2>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3424:	25850513          	addi	a0,a0,600 # 7678 <malloc+0x19f2>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343c:	f6050513          	addi	a0,a0,-160 # 7398 <malloc+0x1712>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3452:	f4a50513          	addi	a0,a0,-182 # 7398 <malloc+0x1712>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3468:	f3450513          	addi	a0,a0,-204 # 7398 <malloc+0x1712>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347c:	29058593          	addi	a1,a1,656 # 7708 <malloc+0x1a82>
    3480:	00004517          	auipc	a0,0x4
    3484:	1c850513          	addi	a0,a0,456 # 7648 <malloc+0x19c2>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3498:	27458593          	addi	a1,a1,628 # 7708 <malloc+0x1a82>
    349c:	00004517          	auipc	a0,0x4
    34a0:	1dc50513          	addi	a0,a0,476 # 7678 <malloc+0x19f2>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b4:	01058593          	addi	a1,a1,16 # 74c0 <malloc+0x183a>
    34b8:	00004517          	auipc	a0,0x4
    34bc:	f0050513          	addi	a0,a0,-256 # 73b8 <malloc+0x1732>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d0:	17c50513          	addi	a0,a0,380 # 7648 <malloc+0x19c2>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e4:	19850513          	addi	a0,a0,408 # 7678 <malloc+0x19f2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f8:	fcc50513          	addi	a0,a0,-52 # 74c0 <malloc+0x183a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350c:	17050513          	addi	a0,a0,368 # 7678 <malloc+0x19f2>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3520:	12c50513          	addi	a0,a0,300 # 7648 <malloc+0x19c2>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3534:	e8850513          	addi	a0,a0,-376 # 73b8 <malloc+0x1732>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3548:	31450513          	addi	a0,a0,788 # 7858 <malloc+0x1bd2>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355c:	f6850513          	addi	a0,a0,-152 # 74c0 <malloc+0x183a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3570:	e4c50513          	addi	a0,a0,-436 # 73b8 <malloc+0x1732>
  ...
  if(unlink("dd") == 0){
    ...
    3584:	e1850513          	addi	a0,a0,-488 # 7398 <malloc+0x1712>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3598:	33450513          	addi	a0,a0,820 # 78c8 <malloc+0x1c42>
  ...
  if(unlink("dd") < 0){
    ...
    35ac:	df050513          	addi	a0,a0,-528 # 7398 <malloc+0x1712>
    ...
    35ce:	dd650513          	addi	a0,a0,-554 # 73a0 <malloc+0x171a>
    35d2:	00002097          	auipc	ra,0x2
    35d6:	5f6080e7          	jalr	1526(ra) # 5bc8 <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35ea:	dda50513          	addi	a0,a0,-550 # 73c0 <malloc+0x173a>
    35ee:	00002097          	auipc	ra,0x2
    35f2:	5da080e7          	jalr	1498(ra) # 5bc8 <printf>
    exit(1);
    35f6:	4505                	li	a0,1
    ...
    3606:	dde50513          	addi	a0,a0,-546 # 73e0 <malloc+0x175a>
    360a:	00002097          	auipc	ra,0x2
    360e:	5be080e7          	jalr	1470(ra) # 5bc8 <printf>
    exit(1);
    3612:	4505                	li	a0,1
    ...
    3622:	dfa50513          	addi	a0,a0,-518 # 7418 <malloc+0x1792>
    3626:	00002097          	auipc	ra,0x2
    362a:	5a2080e7          	jalr	1442(ra) # 5bc8 <printf>
    exit(1);
    362e:	4505                	li	a0,1
    ...
    363e:	e0e50513          	addi	a0,a0,-498 # 7448 <malloc+0x17c2>
    3642:	00002097          	auipc	ra,0x2
    3646:	586080e7          	jalr	1414(ra) # 5bc8 <printf>
    exit(1);
    364a:	4505                	li	a0,1
    ...
    365a:	e2a50513          	addi	a0,a0,-470 # 7480 <malloc+0x17fa>
    365e:	00002097          	auipc	ra,0x2
    3662:	56a080e7          	jalr	1386(ra) # 5bc8 <printf>
    exit(1);
    3666:	4505                	li	a0,1
    ...
    3676:	e2e50513          	addi	a0,a0,-466 # 74a0 <malloc+0x181a>
    367a:	00002097          	auipc	ra,0x2
    367e:	54e080e7          	jalr	1358(ra) # 5bc8 <printf>
    exit(1);
    3682:	4505                	li	a0,1
    ...
    3692:	e4250513          	addi	a0,a0,-446 # 74d0 <malloc+0x184a>
    3696:	00002097          	auipc	ra,0x2
    369a:	532080e7          	jalr	1330(ra) # 5bc8 <printf>
    exit(1);
    369e:	4505                	li	a0,1
    ...
    36ae:	e4e50513          	addi	a0,a0,-434 # 74f8 <malloc+0x1872>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	516080e7          	jalr	1302(ra) # 5bc8 <printf>
    exit(1);
    36ba:	4505                	li	a0,1
    ...
    36ca:	e5250513          	addi	a0,a0,-430 # 7518 <malloc+0x1892>
    36ce:	00002097          	auipc	ra,0x2
    36d2:	4fa080e7          	jalr	1274(ra) # 5bc8 <printf>
    exit(1);
    36d6:	4505                	li	a0,1
    ...
    36e6:	e5e50513          	addi	a0,a0,-418 # 7540 <malloc+0x18ba>
    36ea:	00002097          	auipc	ra,0x2
    36ee:	4de080e7          	jalr	1246(ra) # 5bc8 <printf>
    exit(1);
    36f2:	4505                	li	a0,1
    ...
    3702:	e6a50513          	addi	a0,a0,-406 # 7568 <malloc+0x18e2>
    3706:	00002097          	auipc	ra,0x2
    370a:	4c2080e7          	jalr	1218(ra) # 5bc8 <printf>
    exit(1);
    370e:	4505                	li	a0,1
    ...
    371e:	e7e50513          	addi	a0,a0,-386 # 7598 <malloc+0x1912>
    3722:	00002097          	auipc	ra,0x2
    3726:	4a6080e7          	jalr	1190(ra) # 5bc8 <printf>
    exit(1);
    372a:	4505                	li	a0,1
    ...
    373a:	e8a50513          	addi	a0,a0,-374 # 75c0 <malloc+0x193a>
    373e:	00002097          	auipc	ra,0x2
    3742:	48a080e7          	jalr	1162(ra) # 5bc8 <printf>
    exit(1);
    3746:	4505                	li	a0,1
    ...
    3756:	e8650513          	addi	a0,a0,-378 # 75d8 <malloc+0x1952>
    375a:	00002097          	auipc	ra,0x2
    375e:	46e080e7          	jalr	1134(ra) # 5bc8 <printf>
    exit(1);
    3762:	4505                	li	a0,1
    ...
    3772:	e8a50513          	addi	a0,a0,-374 # 75f8 <malloc+0x1972>
    3776:	00002097          	auipc	ra,0x2
    377a:	452080e7          	jalr	1106(ra) # 5bc8 <printf>
    exit(1);
    377e:	4505                	li	a0,1
    ...
    378e:	e8e50513          	addi	a0,a0,-370 # 7618 <malloc+0x1992>
    3792:	00002097          	auipc	ra,0x2
    3796:	436080e7          	jalr	1078(ra) # 5bc8 <printf>
    exit(1);
    379a:	4505                	li	a0,1
    ...
    37aa:	eb250513          	addi	a0,a0,-334 # 7658 <malloc+0x19d2>
    37ae:	00002097          	auipc	ra,0x2
    37b2:	41a080e7          	jalr	1050(ra) # 5bc8 <printf>
    exit(1);
    37b6:	4505                	li	a0,1
    ...
    37c6:	ec650513          	addi	a0,a0,-314 # 7688 <malloc+0x1a02>
    37ca:	00002097          	auipc	ra,0x2
    37ce:	3fe080e7          	jalr	1022(ra) # 5bc8 <printf>
    exit(1);
    37d2:	4505                	li	a0,1
    ...
    37e2:	eca50513          	addi	a0,a0,-310 # 76a8 <malloc+0x1a22>
    37e6:	00002097          	auipc	ra,0x2
    37ea:	3e2080e7          	jalr	994(ra) # 5bc8 <printf>
    exit(1);
    37ee:	4505                	li	a0,1
    ...
    37fe:	ece50513          	addi	a0,a0,-306 # 76c8 <malloc+0x1a42>
    3802:	00002097          	auipc	ra,0x2
    3806:	3c6080e7          	jalr	966(ra) # 5bc8 <printf>
    exit(1);
    380a:	4505                	li	a0,1
    ...
    381a:	ed250513          	addi	a0,a0,-302 # 76e8 <malloc+0x1a62>
    381e:	00002097          	auipc	ra,0x2
    3822:	3aa080e7          	jalr	938(ra) # 5bc8 <printf>
    exit(1);
    3826:	4505                	li	a0,1
    ...
    3836:	ee650513          	addi	a0,a0,-282 # 7718 <malloc+0x1a92>
    383a:	00002097          	auipc	ra,0x2
    383e:	38e080e7          	jalr	910(ra) # 5bc8 <printf>
    exit(1);
    3842:	4505                	li	a0,1
    ...
    3852:	ef250513          	addi	a0,a0,-270 # 7740 <malloc+0x1aba>
    3856:	00002097          	auipc	ra,0x2
    385a:	372080e7          	jalr	882(ra) # 5bc8 <printf>
    exit(1);
    385e:	4505                	li	a0,1
    ...
    386e:	efe50513          	addi	a0,a0,-258 # 7768 <malloc+0x1ae2>
    3872:	00002097          	auipc	ra,0x2
    3876:	356080e7          	jalr	854(ra) # 5bc8 <printf>
    exit(1);
    387a:	4505                	li	a0,1
    ...
    388a:	f0a50513          	addi	a0,a0,-246 # 7790 <malloc+0x1b0a>
    388e:	00002097          	auipc	ra,0x2
    3892:	33a080e7          	jalr	826(ra) # 5bc8 <printf>
    exit(1);
    3896:	4505                	li	a0,1
    ...
    38a6:	f0e50513          	addi	a0,a0,-242 # 77b0 <malloc+0x1b2a>
    38aa:	00002097          	auipc	ra,0x2
    38ae:	31e080e7          	jalr	798(ra) # 5bc8 <printf>
    exit(1);
    38b2:	4505                	li	a0,1
    ...
    38c2:	f1250513          	addi	a0,a0,-238 # 77d0 <malloc+0x1b4a>
    38c6:	00002097          	auipc	ra,0x2
    38ca:	302080e7          	jalr	770(ra) # 5bc8 <printf>
    exit(1);
    38ce:	4505                	li	a0,1
    ...
    38de:	f1e50513          	addi	a0,a0,-226 # 77f8 <malloc+0x1b72>
    38e2:	00002097          	auipc	ra,0x2
    38e6:	2e6080e7          	jalr	742(ra) # 5bc8 <printf>
    exit(1);
    38ea:	4505                	li	a0,1
    ...
    38fa:	f2250513          	addi	a0,a0,-222 # 7818 <malloc+0x1b92>
    38fe:	00002097          	auipc	ra,0x2
    3902:	2ca080e7          	jalr	714(ra) # 5bc8 <printf>
    exit(1);
    3906:	4505                	li	a0,1
    ...
    3916:	f2650513          	addi	a0,a0,-218 # 7838 <malloc+0x1bb2>
    391a:	00002097          	auipc	ra,0x2
    391e:	2ae080e7          	jalr	686(ra) # 5bc8 <printf>
    exit(1);
    3922:	4505                	li	a0,1
    ...
    3932:	f3250513          	addi	a0,a0,-206 # 7860 <malloc+0x1bda>
    3936:	00002097          	auipc	ra,0x2
    393a:	292080e7          	jalr	658(ra) # 5bc8 <printf>
    exit(1);
    393e:	4505                	li	a0,1
    ...
    394e:	bae50513          	addi	a0,a0,-1106 # 74f8 <malloc+0x1872>
    3952:	00002097          	auipc	ra,0x2
    3956:	276080e7          	jalr	630(ra) # 5bc8 <printf>
    exit(1);
    395a:	4505                	li	a0,1
    ...
    396a:	f1a50513          	addi	a0,a0,-230 # 7880 <malloc+0x1bfa>
    396e:	00002097          	auipc	ra,0x2
    3972:	25a080e7          	jalr	602(ra) # 5bc8 <printf>
    exit(1);
    3976:	4505                	li	a0,1
    ...
    3986:	f1e50513          	addi	a0,a0,-226 # 78a0 <malloc+0x1c1a>
    398a:	00002097          	auipc	ra,0x2
    398e:	23e080e7          	jalr	574(ra) # 5bc8 <printf>
    exit(1);
    3992:	4505                	li	a0,1
    ...
    39a2:	f3250513          	addi	a0,a0,-206 # 78d0 <malloc+0x1c4a>
    39a6:	00002097          	auipc	ra,0x2
    39aa:	222080e7          	jalr	546(ra) # 5bc8 <printf>
    exit(1);
    39ae:	4505                	li	a0,1
    ...
    39be:	f3650513          	addi	a0,a0,-202 # 78f0 <malloc+0x1c6a>
    39c2:	00002097          	auipc	ra,0x2
    39c6:	206080e7          	jalr	518(ra) # 5bc8 <printf>
    exit(1);
    39ca:	4505                	li	a0,1
...
00000000000039d4 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e4:	f2850513          	addi	a0,a0,-216 # 7908 <malloc+0x1c82>
  ...
  if(chdir("dots") != 0){
    ...
    39f6:	f1650513          	addi	a0,a0,-234 # 7908 <malloc+0x1c82>
  ...
  if(unlink(".") == 0){
    ...
    3a08:	d9c50513          	addi	a0,a0,-612 # 67a0 <malloc+0xb1a>
  ...
  if(unlink("..") == 0){
    ...
    3a1a:	94a50513          	addi	a0,a0,-1718 # 7360 <malloc+0x16da>
  ...
  if(chdir("/") != 0){
    ...
    3a2c:	8e050513          	addi	a0,a0,-1824 # 7308 <malloc+0x1682>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a3e:	f3650513          	addi	a0,a0,-202 # 7970 <malloc+0x1cea>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a50:	f4c50513          	addi	a0,a0,-180 # 7998 <malloc+0x1d12>
  ...
  if(unlink("dots") != 0){
    ...
    3a62:	eaa50513          	addi	a0,a0,-342 # 7908 <malloc+0x1c82>
    ...
    3a80:	e9450513          	addi	a0,a0,-364 # 7910 <malloc+0x1c8a>
    3a84:	00002097          	auipc	ra,0x2
    3a88:	144080e7          	jalr	324(ra) # 5bc8 <printf>
    exit(1);
    3a8c:	4505                	li	a0,1
    ...
    3a9c:	e9050513          	addi	a0,a0,-368 # 7928 <malloc+0x1ca2>
    3aa0:	00002097          	auipc	ra,0x2
    3aa4:	128080e7          	jalr	296(ra) # 5bc8 <printf>
    exit(1);
    3aa8:	4505                	li	a0,1
    ...
    3ab8:	e8c50513          	addi	a0,a0,-372 # 7940 <malloc+0x1cba>
    3abc:	00002097          	auipc	ra,0x2
    3ac0:	10c080e7          	jalr	268(ra) # 5bc8 <printf>
    exit(1);
    3ac4:	4505                	li	a0,1
    ...
    3ad4:	e8850513          	addi	a0,a0,-376 # 7958 <malloc+0x1cd2>
    3ad8:	00002097          	auipc	ra,0x2
    3adc:	0f0080e7          	jalr	240(ra) # 5bc8 <printf>
    exit(1);
    3ae0:	4505                	li	a0,1
    ...
    3af0:	82450513          	addi	a0,a0,-2012 # 7310 <malloc+0x168a>
    3af4:	00002097          	auipc	ra,0x2
    3af8:	0d4080e7          	jalr	212(ra) # 5bc8 <printf>
    exit(1);
    3afc:	4505                	li	a0,1
    ...
    3b0c:	e7050513          	addi	a0,a0,-400 # 7978 <malloc+0x1cf2>
    3b10:	00002097          	auipc	ra,0x2
    3b14:	0b8080e7          	jalr	184(ra) # 5bc8 <printf>
    exit(1);
    3b18:	4505                	li	a0,1
    ...
    3b28:	e7c50513          	addi	a0,a0,-388 # 79a0 <malloc+0x1d1a>
    3b2c:	00002097          	auipc	ra,0x2
    3b30:	09c080e7          	jalr	156(ra) # 5bc8 <printf>
    exit(1);
    3b34:	4505                	li	a0,1
    ...
    3b44:	e8050513          	addi	a0,a0,-384 # 79c0 <malloc+0x1d3a>
    3b48:	00002097          	auipc	ra,0x2
    3b4c:	080080e7          	jalr	128(ra) # 5bc8 <printf>
    exit(1);
    3b50:	4505                	li	a0,1
...
0000000000003b5a <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b70:	53c50513          	addi	a0,a0,1340 # 60a8 <malloc+0x422>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8c:	52050513          	addi	a0,a0,1312 # 60a8 <malloc+0x422>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba0:	e8450513          	addi	a0,a0,-380 # 7a20 <malloc+0x1d9a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb8:	e6c50513          	addi	a0,a0,-404 # 7a20 <malloc+0x1d9a>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bcc:	e5850513          	addi	a0,a0,-424 # 7a20 <malloc+0x1d9a>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be0:	e4450513          	addi	a0,a0,-444 # 7a20 <malloc+0x1d9a>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf4:	e3058593          	addi	a1,a1,-464 # 7a20 <malloc+0x1d9a>
    3bf8:	00002517          	auipc	a0,0x2
    3bfc:	6a850513          	addi	a0,a0,1704 # 62a0 <malloc+0x61a>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c10:	49c50513          	addi	a0,a0,1180 # 60a8 <malloc+0x422>
  ...
  fd = open(".", O_RDWR);
    ...
    3c26:	b7e50513          	addi	a0,a0,-1154 # 67a0 <malloc+0xb1a>
  ...
  fd = open(".", 0);
    ...
    3c3c:	b6850513          	addi	a0,a0,-1176 # 67a0 <malloc+0xb1a>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c50:	52c58593          	addi	a1,a1,1324 # 6178 <malloc+0x4f2>
  ...
  close(fd);
    ...
    3c7c:	d6850513          	addi	a0,a0,-664 # 79e0 <malloc+0x1d5a>
    3c80:	00002097          	auipc	ra,0x2
    3c84:	f48080e7          	jalr	-184(ra) # 5bc8 <printf>
    exit(1);
    3c88:	4505                	li	a0,1
    ...
    3c98:	d6c50513          	addi	a0,a0,-660 # 7a00 <malloc+0x1d7a>
    3c9c:	00002097          	auipc	ra,0x2
    3ca0:	f2c080e7          	jalr	-212(ra) # 5bc8 <printf>
    exit(1);
    3ca4:	4505                	li	a0,1
    ...
    3cb4:	d8050513          	addi	a0,a0,-640 # 7a30 <malloc+0x1daa>
    3cb8:	00002097          	auipc	ra,0x2
    3cbc:	f10080e7          	jalr	-240(ra) # 5bc8 <printf>
    exit(1);
    3cc0:	4505                	li	a0,1
    ...
    3cd0:	d6450513          	addi	a0,a0,-668 # 7a30 <malloc+0x1daa>
    3cd4:	00002097          	auipc	ra,0x2
    3cd8:	ef4080e7          	jalr	-268(ra) # 5bc8 <printf>
    exit(1);
    3cdc:	4505                	li	a0,1
    ...
    3cec:	d7050513          	addi	a0,a0,-656 # 7a58 <malloc+0x1dd2>
    3cf0:	00002097          	auipc	ra,0x2
    3cf4:	ed8080e7          	jalr	-296(ra) # 5bc8 <printf>
    exit(1);
    3cf8:	4505                	li	a0,1
    ...
    3d08:	d7c50513          	addi	a0,a0,-644 # 7a80 <malloc+0x1dfa>
    3d0c:	00002097          	auipc	ra,0x2
    3d10:	ebc080e7          	jalr	-324(ra) # 5bc8 <printf>
    exit(1);
    3d14:	4505                	li	a0,1
    ...
    3d24:	d8850513          	addi	a0,a0,-632 # 7aa8 <malloc+0x1e22>
    3d28:	00002097          	auipc	ra,0x2
    3d2c:	ea0080e7          	jalr	-352(ra) # 5bc8 <printf>
    exit(1);
    3d30:	4505                	li	a0,1
    ...
    3d40:	d9450513          	addi	a0,a0,-620 # 7ad0 <malloc+0x1e4a>
    3d44:	00002097          	auipc	ra,0x2
    3d48:	e84080e7          	jalr	-380(ra) # 5bc8 <printf>
    exit(1);
    3d4c:	4505                	li	a0,1
    ...
    3d5c:	d9850513          	addi	a0,a0,-616 # 7af0 <malloc+0x1e6a>
    3d60:	00002097          	auipc	ra,0x2
    3d64:	e68080e7          	jalr	-408(ra) # 5bc8 <printf>
    exit(1);
    3d68:	4505                	li	a0,1
    ...
    3d78:	da450513          	addi	a0,a0,-604 # 7b18 <malloc+0x1e92>
    3d7c:	00002097          	auipc	ra,0x2
    3d80:	e4c080e7          	jalr	-436(ra) # 5bc8 <printf>
    exit(1);
    3d84:	4505                	li	a0,1
...
0000000000003d8e <iref>:
{
    ...
    3dac:	d88a0a13          	addi	s4,s4,-632 # 7b30 <malloc+0x1eaa>
    mkdir("");
    3db0:	00004497          	auipc	s1,0x4
    3db4:	89048493          	addi	s1,s1,-1904 # 7640 <malloc+0x19ba>
    link("README", "");
    3db8:	00002a97          	auipc	s5,0x2
    3dbc:	4e8a8a93          	addi	s5,s5,1256 # 62a0 <malloc+0x61a>
    fd = open("xx", O_CREATE);
    3dc0:	00004997          	auipc	s3,0x4
    3dc4:	c6898993          	addi	s3,s3,-920 # 7a28 <malloc+0x1da2>
    3dc8:	a891                	j	3e1c <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dca:	85da                	mv	a1,s6
    3dcc:	00004517          	auipc	a0,0x4
    3dd0:	d6c50513          	addi	a0,a0,-660 # 7b38 <malloc+0x1eb2>
    3dd4:	00002097          	auipc	ra,0x2
    3dd8:	df4080e7          	jalr	-524(ra) # 5bc8 <printf>
      exit(1);
    3ddc:	4505                	li	a0,1
    ...
    3dec:	d6850513          	addi	a0,a0,-664 # 7b50 <malloc+0x1eca>
    3df0:	00002097          	auipc	ra,0x2
    3df4:	dd8080e7          	jalr	-552(ra) # 5bc8 <printf>
      exit(1);
    3df8:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e80:	4e498993          	addi	s3,s3,1252 # 7360 <malloc+0x16da>
    unlink("irefd");
    3e84:	00004917          	auipc	s2,0x4
    3e88:	cac90913          	addi	s2,s2,-852 # 7b30 <malloc+0x1eaa>
    chdir("..");
    3e8c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea8:	46450513          	addi	a0,a0,1124 # 7308 <malloc+0x1682>
...
0000000000003ec8 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed8:	c9450513          	addi	a0,a0,-876 # 7b68 <malloc+0x1ee2>
  ...
  if(pid == 0){
    ...
    3efc:	c7050513          	addi	a0,a0,-912 # 7b68 <malloc+0x1ee2>
    ...
    3f12:	c7a50513          	addi	a0,a0,-902 # 7b88 <malloc+0x1f02>
    3f16:	00002097          	auipc	ra,0x2
    3f1a:	cb2080e7          	jalr	-846(ra) # 5bc8 <printf>
      exit(1);
    3f1e:	4505                	li	a0,1
    ...
    3f2e:	c4650513          	addi	a0,a0,-954 # 7b70 <malloc+0x1eea>
    3f32:	00002097          	auipc	ra,0x2
    3f36:	c96080e7          	jalr	-874(ra) # 5bc8 <printf>
    exit(1);
    3f3a:	4505                	li	a0,1
    ...
    3f4a:	9fa50513          	addi	a0,a0,-1542 # 6940 <malloc+0xcba>
    3f4e:	00002097          	auipc	ra,0x2
    3f52:	c7a080e7          	jalr	-902(ra) # 5bc8 <printf>
    exit(1);
    3f56:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f78:	bf450513          	addi	a0,a0,-1036 # 7b68 <malloc+0x1ee2>
    ...
    3f8c:	ba850513          	addi	a0,a0,-1112 # 6b30 <malloc+0xeaa>
    3f90:	00002097          	auipc	ra,0x2
    3f94:	c38080e7          	jalr	-968(ra) # 5bc8 <printf>
    exit(1);
    3f98:	4505                	li	a0,1
...
0000000000003fba <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fca:	bea50513          	addi	a0,a0,-1046 # 7bb0 <malloc+0x1f2a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff6:	bbe50513          	addi	a0,a0,-1090 # 7bb0 <malloc+0x1f2a>
  ...
  sleep(10); // one second
    ...
    402e:	ad650513          	addi	a0,a0,-1322 # 6b00 <malloc+0xe7a>
    4032:	00002097          	auipc	ra,0x2
    4036:	b96080e7          	jalr	-1130(ra) # 5bc8 <printf>
    exit(1);
    403a:	4505                	li	a0,1
    ...
    4048:	b6c48493          	addi	s1,s1,-1172 # 7bb0 <malloc+0x1f2a>
    404c:	4581                	li	a1,0
    404e:	8526                	mv	a0,s1
...
000000000000408a <killstatus>:
{
  ...
  exit(0);
    ...
    40f0:	85450513          	addi	a0,a0,-1964 # 6940 <malloc+0xcba>
    40f4:	00002097          	auipc	ra,0x2
    40f8:	ad4080e7          	jalr	-1324(ra) # 5bc8 <printf>
      exit(1);
    40fc:	4505                	li	a0,1
    ...
    4116:	aae50513          	addi	a0,a0,-1362 # 7bc0 <malloc+0x1f3a>
    411a:	00002097          	auipc	ra,0x2
    411e:	aae080e7          	jalr	-1362(ra) # 5bc8 <printf>
       exit(1);
    4122:	4505                	li	a0,1
...
000000000000412c <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4156:	9ae50513          	addi	a0,a0,-1618 # 6b00 <malloc+0xe7a>
    415a:	00002097          	auipc	ra,0x2
    415e:	a6e080e7          	jalr	-1426(ra) # 5bc8 <printf>
    exit(1);
    4162:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4184:	7c050513          	addi	a0,a0,1984 # 6940 <malloc+0xcba>
    4188:	00002097          	auipc	ra,0x2
    418c:	a40080e7          	jalr	-1472(ra) # 5bc8 <printf>
    exit(1);
    4190:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c8:	fb458593          	addi	a1,a1,-76 # 6178 <malloc+0x4f2>
    ...
    41f2:	75250513          	addi	a0,a0,1874 # 6940 <malloc+0xcba>
    41f6:	00002097          	auipc	ra,0x2
    41fa:	9d2080e7          	jalr	-1582(ra) # 5bc8 <printf>
     exit(1);
    41fe:	4505                	li	a0,1
    ...
    420e:	9d650513          	addi	a0,a0,-1578 # 7be0 <malloc+0x1f5a>
    4212:	00002097          	auipc	ra,0x2
    4216:	9b6080e7          	jalr	-1610(ra) # 5bc8 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    422e:	b6658593          	addi	a1,a1,-1178 # bd90 <buf>
    ...
    424a:	9b250513          	addi	a0,a0,-1614 # 7bf8 <malloc+0x1f72>
    424e:	00002097          	auipc	ra,0x2
    4252:	97a080e7          	jalr	-1670(ra) # 5bc8 <printf>
}
  ...
  printf("kill... ");
    ...
    4276:	99e50513          	addi	a0,a0,-1634 # 7c10 <malloc+0x1f8a>
    427a:	00002097          	auipc	ra,0x2
    427e:	94e080e7          	jalr	-1714(ra) # 5bc8 <printf>
  kill(pid1);
    4282:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    42a4:	98050513          	addi	a0,a0,-1664 # 7c20 <malloc+0x1f9a>
    42a8:	00002097          	auipc	ra,0x2
    42ac:	920080e7          	jalr	-1760(ra) # 5bc8 <printf>
  wait(0);
    42b0:	4501                	li	a0,0
...
00000000000042d0 <reparent>:
{
  ...
  exit(0);
    ...
    4324:	62050513          	addi	a0,a0,1568 # 6940 <malloc+0xcba>
    4328:	00002097          	auipc	ra,0x2
    432c:	8a0080e7          	jalr	-1888(ra) # 5bc8 <printf>
      exit(1);
    4330:	4505                	li	a0,1
    ...
    4340:	78c50513          	addi	a0,a0,1932 # 6ac8 <malloc+0xe42>
    4344:	00002097          	auipc	ra,0x2
    4348:	884080e7          	jalr	-1916(ra) # 5bc8 <printf>
        exit(1);
    434c:	4505                	li	a0,1
...
0000000000004380 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b6:	69650513          	addi	a0,a0,1686 # 6a48 <malloc+0xdc2>
    43ba:	00002097          	auipc	ra,0x2
    43be:	80e080e7          	jalr	-2034(ra) # 5bc8 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43ea:	d9258593          	addi	a1,a1,-622 # 6178 <malloc+0x4f2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44ae:	78650513          	addi	a0,a0,1926 # 7c30 <malloc+0x1faa>
    44b2:	00001097          	auipc	ra,0x1
    44b6:	716080e7          	jalr	1814(ra) # 5bc8 <printf>
    exit(1);
    44ba:	4505                	li	a0,1
    ...
    44ca:	47a50513          	addi	a0,a0,1146 # 6940 <malloc+0xcba>
    44ce:	00001097          	auipc	ra,0x1
    44d2:	6fa080e7          	jalr	1786(ra) # 5bc8 <printf>
    exit(1);
    44d6:	4505                	li	a0,1
    ...
    4500:	6705                	lui	a4,0x1
      n += *(a+i);
    4502:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1260>
    ...
    4516:	73e50513          	addi	a0,a0,1854 # 7c50 <malloc+0x1fca>
    451a:	00001097          	auipc	ra,0x1
    451e:	6ae080e7          	jalr	1710(ra) # 5bc8 <printf>
    exit(1);
    4522:	4505                	li	a0,1
...
0000000000004536 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4580:	70a080e7          	jalr	1802(ra) # 5c86 <malloc>
    ...
    45ba:	6ca50513          	addi	a0,a0,1738 # 7c80 <malloc+0x1ffa>
    45be:	00001097          	auipc	ra,0x1
    45c2:	60a080e7          	jalr	1546(ra) # 5bc8 <printf>
      exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4670:	63450513          	addi	a0,a0,1588 # 7ca0 <malloc+0x201a>
    4674:	00001097          	auipc	ra,0x1
    4678:	554080e7          	jalr	1364(ra) # 5bc8 <printf>
    exit(1);
    467c:	4505                	li	a0,1
    ...
    468c:	64050513          	addi	a0,a0,1600 # 7cc8 <malloc+0x2042>
    4690:	00001097          	auipc	ra,0x1
    4694:	538080e7          	jalr	1336(ra) # 5bc8 <printf>
      exit(1);
    4698:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d0:	84c50513          	addi	a0,a0,-1972 # 5f18 <malloc+0x292>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4710:	5dc50513          	addi	a0,a0,1500 # 7ce8 <malloc+0x2062>
    4714:	00001097          	auipc	ra,0x1
    4718:	4b4080e7          	jalr	1204(ra) # 5bc8 <printf>
    exit(1);
    471c:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    474c:	7d050513          	addi	a0,a0,2000 # 5f18 <malloc+0x292>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4772:	5a250513          	addi	a0,a0,1442 # 7d10 <malloc+0x208a>
    4776:	00001097          	auipc	ra,0x1
    477a:	452080e7          	jalr	1106(ra) # 5bc8 <printf>
    exit(1);
    477e:	4505                	li	a0,1
...
0000000000004792 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b8:	5bc78793          	addi	a5,a5,1468 # 5d70 <malloc+0xea>
    47bc:	f6f43823          	sd	a5,-144(s0)
    47c0:	00001797          	auipc	a5,0x1
    47c4:	5b878793          	addi	a5,a5,1464 # 5d78 <malloc+0xf2>
    47c8:	f6f43c23          	sd	a5,-136(s0)
    47cc:	00001797          	auipc	a5,0x1
    47d0:	5b478793          	addi	a5,a5,1460 # 5d80 <malloc+0xfa>
    47d4:	f8f43023          	sd	a5,-128(s0)
    47d8:	00001797          	auipc	a5,0x1
    47dc:	5b078793          	addi	a5,a5,1456 # 5d88 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4834:	560a0a13          	addi	s4,s4,1376 # bd90 <buf>
    4838:	00007a97          	auipc	s5,0x7
    483c:	559a8a93          	addi	s5,s5,1369 # bd91 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4854:	51050513          	addi	a0,a0,1296 # 6d60 <malloc+0x10da>
    4858:	00001097          	auipc	ra,0x1
    485c:	370080e7          	jalr	880(ra) # 5bc8 <printf>
      exit(1);
    4860:	4505                	li	a0,1
    ...
    48d0:	45c50513          	addi	a0,a0,1116 # 7d28 <malloc+0x20a2>
    48d4:	00001097          	auipc	ra,0x1
    48d8:	2f4080e7          	jalr	756(ra) # 5bc8 <printf>
        exit(1);
    48dc:	4505                	li	a0,1
    ...
    48ea:	45250513          	addi	a0,a0,1106 # 7d38 <malloc+0x20b2>
    48ee:	00001097          	auipc	ra,0x1
    48f2:	2da080e7          	jalr	730(ra) # 5bc8 <printf>
          exit(1);
    48f6:	4505                	li	a0,1
    ...
    4912:	44250513          	addi	a0,a0,1090 # 7d50 <malloc+0x20ca>
    4916:	00001097          	auipc	ra,0x1
    491a:	2b2080e7          	jalr	690(ra) # 5bc8 <printf>
          exit(1);
    491e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3c450513          	addi	a0,a0,964 # 7d60 <malloc+0x20da>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	224080e7          	jalr	548(ra) # 5bc8 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	37ab8b93          	addi	s7,s7,890 # 7d78 <malloc+0x20f2>
  for(i = 0; i < N; i++){
    ...
    4a44:	34050513          	addi	a0,a0,832 # 7d80 <malloc+0x20fa>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	180080e7          	jalr	384(ra) # 5bc8 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	31a50513          	addi	a0,a0,794 # 7d78 <malloc+0x20f2>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d0a50513          	addi	a0,a0,-758 # 67a0 <malloc+0xb1a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b10:	29450513          	addi	a0,a0,660 # 7da0 <malloc+0x211a>
    4b14:	00001097          	auipc	ra,0x1
    4b18:	0b4080e7          	jalr	180(ra) # 5bc8 <printf>
        exit(1);
    4b1c:	4505                	li	a0,1
    ...
    4b30:	29450513          	addi	a0,a0,660 # 7dc0 <malloc+0x213a>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	094080e7          	jalr	148(ra) # 5bc8 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	28450513          	addi	a0,a0,644 # 7de8 <malloc+0x2162>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	05c080e7          	jalr	92(ra) # 5bc8 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	dc050513          	addi	a0,a0,-576 # 6940 <malloc+0xcba>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	040080e7          	jalr	64(ra) # 5bc8 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	06e50513          	addi	a0,a0,110 # 7e20 <malloc+0x219a>
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	01a50513          	addi	a0,a0,26 # 7e30 <malloc+0x21aa>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	daa080e7          	jalr	-598(ra) # 5bc8 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	01e50513          	addi	a0,a0,30 # 7e50 <malloc+0x21ca>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	d8e080e7          	jalr	-626(ra) # 5bc8 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	02250513          	addi	a0,a0,34 # 7e70 <malloc+0x21ea>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	d72080e7          	jalr	-654(ra) # 5bc8 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	02650513          	addi	a0,a0,38 # 7e90 <malloc+0x220a>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d56080e7          	jalr	-682(ra) # 5bc8 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	02a50513          	addi	a0,a0,42 # 7eb0 <malloc+0x222a>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d3a080e7          	jalr	-710(ra) # 5bc8 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	02650513          	addi	a0,a0,38 # 7ec8 <malloc+0x2242>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d1e080e7          	jalr	-738(ra) # 5bc8 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f5050513          	addi	a0,a0,-176 # 7e20 <malloc+0x219a>
    ...
    4ef8:	ff450513          	addi	a0,a0,-12 # 7ee8 <malloc+0x2262>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	ccc080e7          	jalr	-820(ra) # 5bc8 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	fdc50513          	addi	a0,a0,-36 # 7f08 <malloc+0x2282>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	c94080e7          	jalr	-876(ra) # 5bc8 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	fccc8c93          	addi	s9,s9,-52 # 7f18 <malloc+0x2292>
    int total = 0;
    4f54:	4d81                	li	s11,0
    ...
    4fa8:	c24080e7          	jalr	-988(ra) # 5bc8 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f6250513          	addi	a0,a0,-158 # 7f28 <malloc+0x22a2>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	bfa080e7          	jalr	-1030(ra) # 5bc8 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f0c50513          	addi	a0,a0,-244 # 7f48 <malloc+0x22c2>
    5044:	00001097          	auipc	ra,0x1
    5048:	b84080e7          	jalr	-1148(ra) # 5bc8 <printf>
}
    ...
    5090:	eac50513          	addi	a0,a0,-340 # 7f38 <malloc+0x22b2>
    5094:	00001097          	auipc	ra,0x1
    5098:	b34080e7          	jalr	-1228(ra) # 5bc8 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e4250513          	addi	a0,a0,-446 # 7f60 <malloc+0x22da>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	04258593          	addi	a1,a1,66 # 6178 <malloc+0x4f2>
    ...
    5150:	e3450513          	addi	a0,a0,-460 # 7f80 <malloc+0x22fa>
    5154:	00001097          	auipc	ra,0x1
    5158:	a74080e7          	jalr	-1420(ra) # 5bc8 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e0250513          	addi	a0,a0,-510 # 7f68 <malloc+0x22e2>
    516e:	00001097          	auipc	ra,0x1
    5172:	a5a080e7          	jalr	-1446(ra) # 5bc8 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	de850513          	addi	a0,a0,-536 # 7f68 <malloc+0x22e2>
    5188:	00001097          	auipc	ra,0x1
    518c:	a40080e7          	jalr	-1472(ra) # 5bc8 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	dbc50513          	addi	a0,a0,-580 # 7f60 <malloc+0x22da>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	f7e98993          	addi	s3,s3,-130 # 6178 <malloc+0x4f2>
      uint64 a = (uint64) sbrk(4096);
    ...
    5230:	da450513          	addi	a0,a0,-604 # 7fd0 <malloc+0x234a>
    5234:	00001097          	auipc	ra,0x1
    5238:	994080e7          	jalr	-1644(ra) # 5bc8 <printf>
        exit(1);
    523c:	4505                	li	a0,1
    ...
    524a:	d4a50513          	addi	a0,a0,-694 # 7f90 <malloc+0x230a>
    524e:	00001097          	auipc	ra,0x1
    5252:	97a080e7          	jalr	-1670(ra) # 5bc8 <printf>
    exit(1);
    5256:	4505                	li	a0,1
    ...
    5264:	d5050513          	addi	a0,a0,-688 # 7fb0 <malloc+0x232a>
    5268:	00001097          	auipc	ra,0x1
    526c:	960080e7          	jalr	-1696(ra) # 5bc8 <printf>
    exit(1);
    5270:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b2:	d4250513          	addi	a0,a0,-702 # 7ff0 <malloc+0x236a>
    52b6:	00001097          	auipc	ra,0x1
    52ba:	912080e7          	jalr	-1774(ra) # 5bc8 <printf>
      exit(1);
    52be:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5302:	d1250513          	addi	a0,a0,-750 # 8010 <malloc+0x238a>
    5306:	00001097          	auipc	ra,0x1
    530a:	8c2080e7          	jalr	-1854(ra) # 5bc8 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5332:	d0a50513          	addi	a0,a0,-758 # 8038 <malloc+0x23b2>
    5336:	00001097          	auipc	ra,0x1
    533a:	892080e7          	jalr	-1902(ra) # 5bc8 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5356:	cce50513          	addi	a0,a0,-818 # 8020 <malloc+0x239a>
    535a:	00001097          	auipc	ra,0x1
    535e:	86e080e7          	jalr	-1938(ra) # 5bc8 <printf>
    exit(1);
    5362:	4505                	li	a0,1
    ...
    537e:	cc650513          	addi	a0,a0,-826 # 8040 <malloc+0x23ba>
    5382:	00001097          	auipc	ra,0x1
    5386:	846080e7          	jalr	-1978(ra) # 5bc8 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c8:	d9478793          	addi	a5,a5,-620 # 8158 <malloc+0x24d2>
    53cc:	bd040713          	addi	a4,s0,-1072
    53d0:	00003317          	auipc	t1,0x3
    53d4:	17830313          	addi	t1,t1,376 # 8548 <malloc+0x28c2>
  ...
  printf("usertests starting\n");
    ...
    5408:	cf450513          	addi	a0,a0,-780 # 80f8 <malloc+0x2472>
    540c:	00000097          	auipc	ra,0x0
    5410:	7bc080e7          	jalr	1980(ra) # 5bc8 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5440:	c7450513          	addi	a0,a0,-908 # 80b0 <malloc+0x242a>
    5444:	00000097          	auipc	ra,0x0
    5448:	784080e7          	jalr	1924(ra) # 5bc8 <printf>
    exit(1);
    544c:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545c:	bf058593          	addi	a1,a1,-1040 # 8048 <malloc+0x23c2>
    ...
    5472:	cc258593          	addi	a1,a1,-830 # 8130 <malloc+0x24aa>
    ...
    5496:	bbe50513          	addi	a0,a0,-1090 # 8050 <malloc+0x23ca>
    549a:	00000097          	auipc	ra,0x0
    549e:	72e080e7          	jalr	1838(ra) # 5bc8 <printf>
    exit(1);
    54a2:	4505                	li	a0,1
    ...
    54c0:	70c080e7          	jalr	1804(ra) # 5bc8 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5502:	b9a50513          	addi	a0,a0,-1126 # 8098 <malloc+0x2412>
    5506:	00000097          	auipc	ra,0x0
    550a:	6c2080e7          	jalr	1730(ra) # 5bc8 <printf>
    exit(1);
    550e:	4505                	li	a0,1
    ...
    551c:	bc850513          	addi	a0,a0,-1080 # 80e0 <malloc+0x245a>
    5520:	00000097          	auipc	ra,0x0
    5524:	6a8080e7          	jalr	1704(ra) # 5bc8 <printf>
    exit(0);
    5528:	4501                	li	a0,0
    ...
    5538:	694080e7          	jalr	1684(ra) # 5bc8 <printf>
        if(continuous != 2)
    ...
    557a:	be278793          	addi	a5,a5,-1054 # 8158 <malloc+0x24d2>
    557e:	bd040713          	addi	a4,s0,-1072
    5582:	00003317          	auipc	t1,0x3
    5586:	fc630313          	addi	t1,t1,-58 # 8548 <malloc+0x28c2>
    ...
    55ba:	b5a50513          	addi	a0,a0,-1190 # 8110 <malloc+0x248a>
    55be:	00000097          	auipc	ra,0x0
    55c2:	60a080e7          	jalr	1546(ra) # 5bc8 <printf>
        printf("SOME TESTS FAILED\n");
    55c6:	00003a97          	auipc	s5,0x3
    55ca:	ad2a8a93          	addi	s5,s5,-1326 # 8098 <malloc+0x2412>
        if(continuous != 2)
    55ce:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d0:	00003b17          	auipc	s6,0x3
    55d4:	aa8b0b13          	addi	s6,s6,-1368 # 8078 <malloc+0x23f2>
...
putc(int fd, char c)
{
    58f0:	1101                	addi	sp,sp,-32
    58f2:	ec06                	sd	ra,24(sp)
    58f4:	e822                	sd	s0,16(sp)
    58f6:	1000                	addi	s0,sp,32
    58f8:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    58fc:	4605                	li	a2,1
    58fe:	fef40593          	addi	a1,s0,-17
    5902:	00000097          	auipc	ra,0x0
    5906:	f66080e7          	jalr	-154(ra) # 5868 <write>
}
    590a:	60e2                	ld	ra,24(sp)
    590c:	6442                	ld	s0,16(sp)
    590e:	6105                	addi	sp,sp,32
    5910:	8082                	ret

0000000000005912 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5912:	7139                	addi	sp,sp,-64
    5914:	fc06                	sd	ra,56(sp)
    5916:	f822                	sd	s0,48(sp)
    5918:	f426                	sd	s1,40(sp)
    591a:	f04a                	sd	s2,32(sp)
    591c:	ec4e                	sd	s3,24(sp)
    591e:	0080                	addi	s0,sp,64
    5920:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5922:	c299                	beqz	a3,5928 <printint+0x16>
    5924:	0805c863          	bltz	a1,59b4 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5928:	2581                	sext.w	a1,a1
  neg = 0;
    592a:	4881                	li	a7,0
    592c:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5932:	2601                	sext.w	a2,a2
    5934:	00003517          	auipc	a0,0x3
    5938:	c1c50513          	addi	a0,a0,-996 # 8550 <digits>
    593c:	883a                	mv	a6,a4
    593e:	2705                	addiw	a4,a4,1
    5940:	02c5f7bb          	remuw	a5,a1,a2
    5944:	1782                	slli	a5,a5,0x20
    5946:	9381                	srli	a5,a5,0x20
    5948:	97aa                	add	a5,a5,a0
    594a:	0007c783          	lbu	a5,0(a5)
    594e:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5952:	0005879b          	sext.w	a5,a1
    5956:	02c5d5bb          	divuw	a1,a1,a2
    595a:	0685                	addi	a3,a3,1
    595c:	fec7f0e3          	bgeu	a5,a2,593c <printint+0x2a>
  if(neg)
    5960:	00088b63          	beqz	a7,5976 <printint+0x64>
    buf[i++] = '-';
    5964:	fd040793          	addi	a5,s0,-48
    5968:	973e                	add	a4,a4,a5
    596a:	02d00793          	li	a5,45
    596e:	fef70823          	sb	a5,-16(a4)
    5972:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5976:	02e05863          	blez	a4,59a6 <printint+0x94>
    597a:	fc040793          	addi	a5,s0,-64
    597e:	00e78933          	add	s2,a5,a4
    5982:	fff78993          	addi	s3,a5,-1
    5986:	99ba                	add	s3,s3,a4
    5988:	377d                	addiw	a4,a4,-1
    598a:	1702                	slli	a4,a4,0x20
    598c:	9301                	srli	a4,a4,0x20
    598e:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5992:	fff94583          	lbu	a1,-1(s2)
    5996:	8526                	mv	a0,s1
    5998:	00000097          	auipc	ra,0x0
    599c:	f58080e7          	jalr	-168(ra) # 58f0 <putc>
  while(--i >= 0)
    59a0:	197d                	addi	s2,s2,-1
    59a2:	ff3918e3          	bne	s2,s3,5992 <printint+0x80>
}
    59a6:	70e2                	ld	ra,56(sp)
    59a8:	7442                	ld	s0,48(sp)
    59aa:	74a2                	ld	s1,40(sp)
    59ac:	7902                	ld	s2,32(sp)
    59ae:	69e2                	ld	s3,24(sp)
    59b0:	6121                	addi	sp,sp,64
    59b2:	8082                	ret
    x = -xx;
    59b4:	40b005bb          	negw	a1,a1
    neg = 1;
    59b8:	4885                	li	a7,1
    x = -xx;
    59ba:	bf8d                	j	592c <printint+0x1a>

00000000000059bc <vprintf>:
}
...
{
    59bc:	7119                	addi	sp,sp,-128
    59be:	fc86                	sd	ra,120(sp)
    59c0:	f8a2                	sd	s0,112(sp)
    59c2:	f4a6                	sd	s1,104(sp)
    59c4:	f0ca                	sd	s2,96(sp)
    59c6:	ecce                	sd	s3,88(sp)
    59c8:	e8d2                	sd	s4,80(sp)
    59ca:	e4d6                	sd	s5,72(sp)
    59cc:	e0da                	sd	s6,64(sp)
    59ce:	fc5e                	sd	s7,56(sp)
    59d0:	f862                	sd	s8,48(sp)
    59d2:	f466                	sd	s9,40(sp)
    59d4:	f06a                	sd	s10,32(sp)
    59d6:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    59da:	0005c903          	lbu	s2,0(a1)
    59de:	18090f63          	beqz	s2,5b7c <vprintf+0x1c0>
    59e2:	8aaa                	mv	s5,a0
    59e4:	8b32                	mv	s6,a2
    59e6:	00158493          	addi	s1,a1,1
  state = 0;
    59ea:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    59ec:	02500a13          	li	s4,37
      if(c == 'd'){
    59f0:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    59f4:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    59f8:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    59fc:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a00:	00003b97          	auipc	s7,0x3
    5a04:	b50b8b93          	addi	s7,s7,-1200 # 8550 <digits>
    5a08:	a839                	j	5a26 <vprintf+0x6a>
        putc(fd, c);
    5a0a:	85ca                	mv	a1,s2
    5a0c:	8556                	mv	a0,s5
    5a0e:	00000097          	auipc	ra,0x0
    5a12:	ee2080e7          	jalr	-286(ra) # 58f0 <putc>
    5a16:	a019                	j	5a1c <vprintf+0x60>
    } else if(state == '%'){
    5a18:	01498f63          	beq	s3,s4,5a36 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a1c:	0485                	addi	s1,s1,1
    5a1e:	fff4c903          	lbu	s2,-1(s1)
    5a22:	14090d63          	beqz	s2,5b7c <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a26:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a2a:	fe0997e3          	bnez	s3,5a18 <vprintf+0x5c>
      if(c == '%'){
    5a2e:	fd479ee3          	bne	a5,s4,5a0a <vprintf+0x4e>
        state = '%';
    5a32:	89be                	mv	s3,a5
    5a34:	b7e5                	j	5a1c <vprintf+0x60>
      if(c == 'd'){
    5a36:	05878063          	beq	a5,s8,5a76 <vprintf+0xba>
      } else if(c == 'l') {
    5a3a:	05978c63          	beq	a5,s9,5a92 <vprintf+0xd6>
      } else if(c == 'x') {
    5a3e:	07a78863          	beq	a5,s10,5aae <vprintf+0xf2>
      } else if(c == 'p') {
    5a42:	09b78463          	beq	a5,s11,5aca <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a46:	07300713          	li	a4,115
    5a4a:	0ce78663          	beq	a5,a4,5b16 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a4e:	06300713          	li	a4,99
    5a52:	0ee78e63          	beq	a5,a4,5b4e <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a56:	11478863          	beq	a5,s4,5b66 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a62:	e92080e7          	jalr	-366(ra) # 58f0 <putc>
        putc(fd, c);
    5a66:	85ca                	mv	a1,s2
    5a68:	8556                	mv	a0,s5
    5a6a:	00000097          	auipc	ra,0x0
    5a6e:	e86080e7          	jalr	-378(ra) # 58f0 <putc>
      }
      state = 0;
    5a72:	4981                	li	s3,0
    5a74:	b765                	j	5a1c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5a88:	e8e080e7          	jalr	-370(ra) # 5912 <printint>
    5a8c:	8b4a                	mv	s6,s2
      state = 0;
    5a8e:	4981                	li	s3,0
    5a90:	b771                	j	5a1c <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5aa4:	e72080e7          	jalr	-398(ra) # 5912 <printint>
    5aa8:	8b4a                	mv	s6,s2
      state = 0;
    5aaa:	4981                	li	s3,0
    5aac:	bf85                	j	5a1c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5ac0:	e56080e7          	jalr	-426(ra) # 5912 <printint>
    5ac4:	8b4a                	mv	s6,s2
      state = 0;
    5ac6:	4981                	li	s3,0
    5ac8:	bf91                	j	5a1c <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    5ae0:	e14080e7          	jalr	-492(ra) # 58f0 <putc>
  putc(fd, 'x');
    5ae4:	85ea                	mv	a1,s10
    5ae6:	8556                	mv	a0,s5
    5ae8:	00000097          	auipc	ra,0x0
    5aec:	e08080e7          	jalr	-504(ra) # 58f0 <putc>
    5af0:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b02:	df2080e7          	jalr	-526(ra) # 58f0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b06:	0992                	slli	s3,s3,0x4
    5b08:	397d                	addiw	s2,s2,-1
    5b0a:	fe0914e3          	bnez	s2,5af2 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b0e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b12:	4981                	li	s3,0
    5b14:	b721                	j	5a1c <vprintf+0x60>
        s = va_arg(ap, char*);
    5b16:	008b0993          	addi	s3,s6,8
    5b1a:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b1e:	02090163          	beqz	s2,5b40 <vprintf+0x184>
        while(*s != 0){
    5b22:	00094583          	lbu	a1,0(s2)
    5b26:	c9a1                	beqz	a1,5b76 <vprintf+0x1ba>
          putc(fd, *s);
    5b28:	8556                	mv	a0,s5
    5b2a:	00000097          	auipc	ra,0x0
    5b2e:	dc6080e7          	jalr	-570(ra) # 58f0 <putc>
          s++;
    5b32:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b34:	00094583          	lbu	a1,0(s2)
    5b38:	f9e5                	bnez	a1,5b28 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b3a:	8b4e                	mv	s6,s3
      state = 0;
    5b3c:	4981                	li	s3,0
    5b3e:	bdf9                	j	5a1c <vprintf+0x60>
          s = "(null)";
    5b40:	00003917          	auipc	s2,0x3
    5b44:	a0890913          	addi	s2,s2,-1528 # 8548 <malloc+0x28c2>
        while(*s != 0){
    5b48:	02800593          	li	a1,40
    5b4c:	bff1                	j	5b28 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b4e:	008b0913          	addi	s2,s6,8
    5b52:	000b4583          	lbu	a1,0(s6)
    5b56:	8556                	mv	a0,s5
    5b58:	00000097          	auipc	ra,0x0
    5b5c:	d98080e7          	jalr	-616(ra) # 58f0 <putc>
    5b60:	8b4a                	mv	s6,s2
      state = 0;
    5b62:	4981                	li	s3,0
    5b64:	bd65                	j	5a1c <vprintf+0x60>
        putc(fd, c);
    5b66:	85d2                	mv	a1,s4
    5b68:	8556                	mv	a0,s5
    5b6a:	00000097          	auipc	ra,0x0
    5b6e:	d86080e7          	jalr	-634(ra) # 58f0 <putc>
      state = 0;
    5b72:	4981                	li	s3,0
    5b74:	b565                	j	5a1c <vprintf+0x60>
        s = va_arg(ap, char*);
    5b76:	8b4e                	mv	s6,s3
      state = 0;
    5b78:	4981                	li	s3,0
    5b7a:	b54d                	j	5a1c <vprintf+0x60>
    }
  }
}
    5b7c:	70e6                	ld	ra,120(sp)
    5b7e:	7446                	ld	s0,112(sp)
    5b80:	74a6                	ld	s1,104(sp)
    5b82:	7906                	ld	s2,96(sp)
    5b84:	69e6                	ld	s3,88(sp)
    5b86:	6a46                	ld	s4,80(sp)
    5b88:	6aa6                	ld	s5,72(sp)
    5b8a:	6b06                	ld	s6,64(sp)
    5b8c:	7be2                	ld	s7,56(sp)
    5b8e:	7c42                	ld	s8,48(sp)
    5b90:	7ca2                	ld	s9,40(sp)
    5b92:	7d02                	ld	s10,32(sp)
    5b94:	6de2                	ld	s11,24(sp)
    5b96:	6109                	addi	sp,sp,128
    5b98:	8082                	ret

0000000000005b9a <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5b9a:	715d                	addi	sp,sp,-80
    5b9c:	ec06                	sd	ra,24(sp)
    5b9e:	e822                	sd	s0,16(sp)
    5ba0:	1000                	addi	s0,sp,32
    5ba2:	e010                	sd	a2,0(s0)
    5ba4:	e414                	sd	a3,8(s0)
    5ba6:	e818                	sd	a4,16(s0)
    5ba8:	ec1c                	sd	a5,24(s0)
    5baa:	03043023          	sd	a6,32(s0)
    5bae:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bb2:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bb6:	8622                	mv	a2,s0
    5bb8:	00000097          	auipc	ra,0x0
    5bbc:	e04080e7          	jalr	-508(ra) # 59bc <vprintf>
}
    5bc0:	60e2                	ld	ra,24(sp)
    5bc2:	6442                	ld	s0,16(sp)
    5bc4:	6161                	addi	sp,sp,80
    5bc6:	8082                	ret

0000000000005bc8 <printf>:

void
printf(const char *fmt, ...)
{
    5bc8:	711d                	addi	sp,sp,-96
    5bca:	ec06                	sd	ra,24(sp)
    5bcc:	e822                	sd	s0,16(sp)
    5bce:	1000                	addi	s0,sp,32
    5bd0:	e40c                	sd	a1,8(s0)
    5bd2:	e810                	sd	a2,16(s0)
    5bd4:	ec14                	sd	a3,24(s0)
    5bd6:	f018                	sd	a4,32(s0)
    5bd8:	f41c                	sd	a5,40(s0)
    5bda:	03043823          	sd	a6,48(s0)
    5bde:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5be2:	00840613          	addi	a2,s0,8
    5be6:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5bea:	85aa                	mv	a1,a0
    5bec:	4505                	li	a0,1
    5bee:	00000097          	auipc	ra,0x0
    5bf2:	dce080e7          	jalr	-562(ra) # 59bc <vprintf>
}
    5bf6:	60e2                	ld	ra,24(sp)
    5bf8:	6442                	ld	s0,16(sp)
    5bfa:	6125                	addi	sp,sp,96
    5bfc:	8082                	ret

0000000000005bfe <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5c04:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c08:	00003797          	auipc	a5,0x3
    5c0c:	9687b783          	ld	a5,-1688(a5) # 8570 <freep>
    5c10:	a805                	j	5c40 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c12:	4618                	lw	a4,8(a2)
    5c14:	9db9                	addw	a1,a1,a4
    5c16:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c1a:	6398                	ld	a4,0(a5)
    5c1c:	6318                	ld	a4,0(a4)
    5c1e:	fee53823          	sd	a4,-16(a0)
    5c22:	a091                	j	5c66 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c24:	ff852703          	lw	a4,-8(a0)
    5c28:	9e39                	addw	a2,a2,a4
    5c2a:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c2c:	ff053703          	ld	a4,-16(a0)
    5c30:	e398                	sd	a4,0(a5)
    5c32:	a099                	j	5c78 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c34:	6398                	ld	a4,0(a5)
    5c36:	00e7e463          	bltu	a5,a4,5c3e <free+0x40>
    5c3a:	00e6ea63          	bltu	a3,a4,5c4e <free+0x50>
{
    5c3e:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c40:	fed7fae3          	bgeu	a5,a3,5c34 <free+0x36>
    5c44:	6398                	ld	a4,0(a5)
    5c46:	00e6e463          	bltu	a3,a4,5c4e <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c4a:	fee7eae3          	bltu	a5,a4,5c3e <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c4e:	ff852583          	lw	a1,-8(a0)
    5c52:	6390                	ld	a2,0(a5)
    5c54:	02059713          	slli	a4,a1,0x20
    5c58:	9301                	srli	a4,a4,0x20
    5c5a:	0712                	slli	a4,a4,0x4
    5c5c:	9736                	add	a4,a4,a3
    5c5e:	fae60ae3          	beq	a2,a4,5c12 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c62:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c66:	4790                	lw	a2,8(a5)
    5c68:	02061713          	slli	a4,a2,0x20
    5c6c:	9301                	srli	a4,a4,0x20
    5c6e:	0712                	slli	a4,a4,0x4
    5c70:	973e                	add	a4,a4,a5
    5c72:	fae689e3          	beq	a3,a4,5c24 <free+0x26>
  } else
    p->s.ptr = bp;
    5c76:	e394                	sd	a3,0(a5)
  freep = p;
    5c78:	00003717          	auipc	a4,0x3
    5c7c:	8ef73c23          	sd	a5,-1800(a4) # 8570 <freep>
}
    5c80:	6422                	ld	s0,8(sp)
    5c82:	0141                	addi	sp,sp,16
    5c84:	8082                	ret

0000000000005c86 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5c86:	7139                	addi	sp,sp,-64
    5c88:	fc06                	sd	ra,56(sp)
    5c8a:	f822                	sd	s0,48(sp)
    5c8c:	f426                	sd	s1,40(sp)
    5c8e:	f04a                	sd	s2,32(sp)
    5c90:	ec4e                	sd	s3,24(sp)
    5c92:	e852                	sd	s4,16(sp)
    5c94:	e456                	sd	s5,8(sp)
    5c96:	e05a                	sd	s6,0(sp)
    5c98:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c9a:	02051493          	slli	s1,a0,0x20
    5c9e:	9081                	srli	s1,s1,0x20
    5ca0:	04bd                	addi	s1,s1,15
    5ca2:	8091                	srli	s1,s1,0x4
    5ca4:	0014899b          	addiw	s3,s1,1
    5ca8:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5caa:	00003517          	auipc	a0,0x3
    5cae:	8c653503          	ld	a0,-1850(a0) # 8570 <freep>
    5cb2:	c515                	beqz	a0,5cde <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cb4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cb6:	4798                	lw	a4,8(a5)
    5cb8:	02977f63          	bgeu	a4,s1,5cf6 <malloc+0x70>
    5cbc:	8a4e                	mv	s4,s3
    5cbe:	0009871b          	sext.w	a4,s3
    5cc2:	6685                	lui	a3,0x1
    5cc4:	00d77363          	bgeu	a4,a3,5cca <malloc+0x44>
    5cc8:	6a05                	lui	s4,0x1
    5cca:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cce:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    5cd6:	89e90913          	addi	s2,s2,-1890 # 8570 <freep>
  if(p == (char*)-1)
    5cda:	5afd                	li	s5,-1
    5cdc:	a88d                	j	5d4e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5cde:	00009797          	auipc	a5,0x9
    5ce2:	0b278793          	addi	a5,a5,178 # ed90 <base>
    5ce6:	00003717          	auipc	a4,0x3
    5cea:	88f73523          	sd	a5,-1910(a4) # 8570 <freep>
    5cee:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cf0:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cf4:	b7e1                	j	5cbc <malloc+0x36>
      if(p->s.size == nunits)
    5cf6:	02e48b63          	beq	s1,a4,5d2c <malloc+0xa6>
        p->s.size -= nunits;
    5cfa:	4137073b          	subw	a4,a4,s3
    5cfe:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d00:	1702                	slli	a4,a4,0x20
    5d02:	9301                	srli	a4,a4,0x20
    5d04:	0712                	slli	a4,a4,0x4
    5d06:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d08:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d0c:	00003717          	auipc	a4,0x3
    5d10:	86a73223          	sd	a0,-1948(a4) # 8570 <freep>
      return (void*)(p + 1);
    ...
    5d30:	bff1                	j	5d0c <malloc+0x86>
  hp->s.size = nu;
    5d32:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d36:	0541                	addi	a0,a0,16
    5d38:	00000097          	auipc	ra,0x0
    5d3c:	ec6080e7          	jalr	-314(ra) # 5bfe <free>
  return freep;
    5d40:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d44:	d971                	beqz	a0,5d18 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d46:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d48:	4798                	lw	a4,8(a5)
    5d4a:	fa9776e3          	bgeu	a4,s1,5cf6 <malloc+0x70>
    if(p == freep)
    5d4e:	00093703          	ld	a4,0(s2)
    5d52:	853e                	mv	a0,a5
    5d54:	fef719e3          	bne	a4,a5,5d46 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d58:	8552                	mv	a0,s4
    5d5a:	00000097          	auipc	ra,0x0
    5d5e:	b76080e7          	jalr	-1162(ra) # 58d0 <sbrk>
  if(p == (char*)-1)
    5d62:	fd5518e3          	bne	a0,s5,5d32 <malloc+0xac>
        return 0;
    5d66:	4501                	li	a0,0
    5d68:	bf45                	j	5d18 <malloc+0x92>
