...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	29a58593          	addi	a1,a1,666 # 12f8 <malloc+0xf8>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	26850513          	addi	a0,a0,616 # 1300 <malloc+0x100>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    panic("runcmd");
      ...
      e2:	22a50513          	addi	a0,a0,554 # 1308 <malloc+0x108>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	21058593          	addi	a1,a1,528 # 1310 <malloc+0x110>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	1d458593          	addi	a1,a1,468 # 1320 <malloc+0x120>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	14e50513          	addi	a0,a0,334 # 1330 <malloc+0x130>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	db6b8b93          	addi	s7,s7,-586 # 1358 <malloc+0x158>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	d8450513          	addi	a0,a0,-636 # 1338 <malloc+0x138>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cc460613          	addi	a2,a2,-828 # 1360 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cb4b0b13          	addi	s6,s6,-844 # 1380 <malloc+0x180>
  ...
  return ret;
     ...
     70a:	c6250513          	addi	a0,a0,-926 # 1368 <malloc+0x168>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c0850513          	addi	a0,a0,-1016 # 1370 <malloc+0x170>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	be660613          	addi	a2,a2,-1050 # 1388 <malloc+0x188>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	b7ea0a13          	addi	s4,s4,-1154 # 1390 <malloc+0x190>
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b5060613          	addi	a2,a2,-1200 # 1398 <malloc+0x198>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	ab260613          	addi	a2,a2,-1358 # 1360 <malloc+0x160>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	ad260613          	addi	a2,a2,-1326 # 13b0 <malloc+0x1b0>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	a8050513          	addi	a0,a0,-1408 # 13a0 <malloc+0x1a0>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	a8850513          	addi	a0,a0,-1400 # 13b8 <malloc+0x1b8>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	8e860613          	addi	a2,a2,-1816 # 12f0 <malloc+0xf0>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a54:	91850513          	addi	a0,a0,-1768 # 1368 <malloc+0x168>
